...
sample). The resulting expected limits are given in~\tab{TGC-robustness}; the changes in expected limits are much smaller
...
\hline\hline
\end{tabular}
           \caption[Robustness of expected 95\% confidence intervals for anomalous neutral
           gauge boson couplings (\TGC s) for the 8~\tev\ analysis.]{
