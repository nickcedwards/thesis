...
notes and publications. An initial measurement of the \ZZ\ \cx\ at \sqrtseq{7} and limits on \TGC s using the
four-lepton final state in 1~\ifb\ of data was presented in \cite{ATLAS-CONF-2011-107} and later
published in \cite{ATLAS_ZZ4l:1fb2011}. An updated measurement of the \cx\ using
the full 7~\tev\ dataset of 4.7~\ifb\ was given in~\cite{ATLAS-CONF-2012-026},
and later a paper published~\cite{ATLAS:2012kg} giving combined results with an analysis of \ZZllvv\
decays, including \TGC\ limits and differential \cx s.
