...
fiducial phase space corresponding closely to the experimental kinematic
selections, termed the \intro{fiducial \cx}, and secondly a \intro{total} \cx,
correcting for the acceptance of the fiducial phase space.
These events are then used to set limits on \TGC s; this is described
in~\chap{TGCLimits}.
