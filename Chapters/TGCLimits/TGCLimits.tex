...
\begin{equation}
{\rm weight} = \frac{{\rm d}\sigma_{\rm SM+TGC}(\ffourg, \ffourZ, \ffiveg)}{{\rm d}\sigma_{\rm SM}}
\end{equation}
By assigning such a weight to every event in a sample it is possible to reweight a sample
