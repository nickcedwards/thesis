...
and the four-lepton invariant mass, which are the regions of greatest interest when studying \TGC s. Instead,
samples generated with values of the \TGC parameters set near previously derived
...
generated without a \formfactor. The reweighting procedure can be used to
