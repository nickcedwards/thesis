...
expected distributions in the case of \TGC s, with parameters set close to the previously obtained
limits.
...
for \TGC s is observed, and the observed limits are consisbwith the expected
