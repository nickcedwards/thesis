...
\caption{         Two dimensional 95\% confidence intervals for anomalous neutral
           ...
           $\Lambda=\infty$. For each pair of parameters, the other parameters
           are assumed to be fixed at their \sm\ value of zero. The limits set
           ...
           data using only the \ZZllll\ channel are shown in black.
