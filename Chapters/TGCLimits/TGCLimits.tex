...
bosons and their decay products would be particularly sensitive to \TGC s.
...
the \pt\ of the leading \Z\ boson, although other variables are considered. Only
...
with observed \ZZllvv\ events; see~\cite{ATLAS:2012kg} for a description of this
analysis.
...
In order to set limits it is necessary to paramterise the expected yield in
terms of the strength of the \TGC\ couplings. One method for doing this would be
to generate a grid of \mc\ samples at different coupling points. This however is
computationally very intensive. Instead, a matrix element reweighting procedure
is used to reweight a sample generated with one set of couplings to another.
This is described in~\sec{TGC-reweighting}.
...
\sec{sec:TGC-ReweightingValidation}
