...
\vspace*{-0.8cm}
 \begin{center}
 \includegraphics[width=0.45\textwidth]{NicePlots/ZZ4l_PtZ_aTGCs.png}
 %\includegraphics[width=0.45\textwidth]{figures/DileptonDphi_ZZmm_diff.png}
 \caption{\label{fig:ZpT_aTGC}\small Z-boson transverse momentum for standard model \ZZ\ (pink) and
 for samples including anomalous triple gauge couplings. The aTGC coupling
 parameters are set at values near the edge of the exclusion set in the
 1f$b^{-1}$ analysis. The left hand plot is for the \zzllll\ channel, and shows
 the leading \Z\ $p_T$. The right hand plot shows the $\Delta\phi$ of the leptonic \Z\
 in \zzllvv\ events.}
 \end{center}
 \end{figure} 
