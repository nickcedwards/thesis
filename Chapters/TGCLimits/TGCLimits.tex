...
\subfigure[\BR]{\includegraphics[width=0.47\textwidth]{ReweightValidation/04_BR/ZZ_Z1_pt_nTGC0}}
\subfigure[\BHO]{\includegraphics[width=0.47\textwidth]{ReweightValidation/04_BHO_noFF/ZZ_Z1_pt_nTGC0}}
\caption{
\small
...
distribution of the leading \leppair, reweighted to the \TGC\ point
$\ffourgamma=0.1\}\}$ (TGC0).
 }
