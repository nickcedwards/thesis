...
A simulated event generated assuming only
\sm\ couplings can be assigned a weight corresponding to the differential \cx\
assuming \TGC\ couplings
at some specific value of the four couplings:
\begin{equation}
{\rm weight} = \frac{{\rm d}\sigma_{\rm SM+TGC}}{{\rm d}\sigma_{\rm SM}}
\end{equation}
By assigning such weights to every event it is possible to reweight a sample
...
a given set of \TGC s to any other set of \TGC s. For example, to reweight a sample
