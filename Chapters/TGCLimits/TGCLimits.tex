...
\centering
  ...
  \caption{\label{ta:TGCLimits}
           ...
           \label{table:TGC-obs-exp-limits}
\end{table}
...
\end{tabular}
           \caption{
           Expected and observed 95\% confidence intervals for anomalous neutral gauge boson couplings, where 
           the limit for each coupling assumes the other couplings
           fixed at their SM value of zero. 
           Limits are presented for \formfactor\ scales of $\Lambda = 3$ \TeV\
           and of $\Lambda = \infty$, corresponding to no \formfactor. 
           %They include 
           %both statistical and systematic uncertainties; the statistical uncertainties are dominant.
           }
           \label{table:TGC-obs-exp-limits}
