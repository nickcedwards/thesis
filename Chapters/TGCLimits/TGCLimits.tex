...
$p(\vec{f})\geq 5\%$. Limits are set for one parameter at a time, holding the
...
at other experiments is shown in~\fig{TGC-SummaryPlot}. The
...
The ATLAS \sqrtseq{7} limits are comparable to
the limits from CMS~\cite{CMS:2012rg} derived at the same centre-of-mass energy using a similarly
