...
limits are sensitive to the lower boundary of the last bin, which is taken to be
...
the bins other than the lower edge of the last bin. \fig{TGC-binOpt}

\begin{figure}[htbp]
\begin{center}
\subfigure[\BR]{\includegraphics[width=0.7\textwidth]{BinOpt/BinOpt_BinOpt_02_130325_newSyst_f4g}
\caption{
\small
 }
