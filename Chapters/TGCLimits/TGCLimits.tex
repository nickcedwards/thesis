...
\begin{figure}[htbp]
\begin{center}
\subfigure[]{\includegraphics[width=0.47\textwidth]{TGCYieldCoeffs/YieldCoeff_f_4gamma}}
\subfigure[]{\includegraphics[width=0.47\textwidth]{TGCYieldCoeffs/YieldCoeff_f_4Z}}
\subfigure[]{\includegraphics[width=0.47\textwidth]{TGCYieldCoeffs/YieldCoeff_f_5gamma}}
\subfigure[]{\includegraphics[width=0.47\textwidth]{TGCYieldCoeffs/YieldCoeff_f_5Z}}
\caption{
\small
Validation of the TGC reweighting procedure for the 8~\tev\ samples. Figures (a) and (b) show the \pt\
distribution of the leading \leppair, comparing the three \TGC\ samples (TGC0,
