...
loops arising from a new generation of heavy fermions. Contributions from loops
of SM particles generate loops at the level of $\mathcal{O}(10^{-4})$. Such
...
order $m_{Z}$ the couplings could be restored, but would be $\prop
\frac{m_{Z}^{4}}{M_{F}^{4}}$ and thus heavily suppressed. In a more
...
This is still suppressed by the loop $\frac{\alpha}{4\pi}$ factor, and yields
