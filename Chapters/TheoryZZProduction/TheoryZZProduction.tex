...
to model QED radiaition, wheras \sherpa\ has it's own internal treatment. There are two
...
the multipole, or assuming two sepaeare dipoles $\Z[\ell\ell]$ and $\~[\ell'\ell']$ each
