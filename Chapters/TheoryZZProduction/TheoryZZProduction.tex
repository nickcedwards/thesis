...
called \intro{diboson \ZZ\ production}) is of great interest
...
at the level of  $10^{-4}$ in one-loop corrections. The size of these nTGCs are,
...
\ZZ\ production is a rare process at particle colliders, but has a very striking signature
and low backgrounds. The study of diboson \ZZ\ production
...
contributing approximately 10\%~\cite{Campbell:2011},
...
In this case the tighter mass cut is applied to the pair furthest from the PDG \Z\
boson mass.
...
the \Z\ pole to $m_{Z}>20$ \gev. The \mZZ\ distribution is similar in both 
...
\centering
    ...
    \subfigure[]{
        ...
        \vspace{-2mm}
    \caption{\small \Z\ boson invariant mass distributions in \ZZllll\ events at
    7 \tev\ after
...
As previously mentioned, the \ZZZ\ and \ZZg\ vertices are forbidden at tree level
...
momentum~\cite{Baur:2000ae}, and at large scattering angles.

\begin{figure}
\centering
        \vspace{-5mm}
    \subfigure[]{
        \includegraphics[width=0.43\textwidth]{ZZ7TeV_TGCRW_n3L3_lin/truth_ZZ_ZZ_m_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.43\textwidth]{ZZ7TeV_TGCRW_n3L3_lin/truth_ZZ_Z1_pt_lin}
    }
        \vspace{-2mm}
    \caption{\small
}
