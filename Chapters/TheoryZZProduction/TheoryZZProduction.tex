...
\centering
        \vspace{10mm}
    \subfigure{
        \includegraphics[width=0.3\textwidth]{truth_ZZ_ZZ_m_lin}
    }
    \subfigure{
        \includegraphics[width=0.3\textwidth]{truth_ZZ_ZZ_pt_lin}
    }
    \subfigure{
        \includegraphics[width=0.3\textwidth]{truth_ZZ_Z1_pt_lin}
    }
    \subfigure{
        \includegraphics[width=0.3\textwidth]{truth_ZZ_lep_1_pt_lin}
    }
    \subfigure{
        \includegraphics[width=0.3\textwidth]{truth_ZZ_lep_1_eta_lin}
    }
    \subfigure{
        \includegraphics[width=0.3\textwidth]{truth_ZZ_lep_4_pt_lin}
    }
    \caption{}
