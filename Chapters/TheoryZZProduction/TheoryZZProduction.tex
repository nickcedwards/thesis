...
The CMS experiment measured the \ZZ\ production
\cx\ in $pp$ collisions at 7~\tev~\cite{CMS:2012rg} using
\ZZllll\ decays. In a dataset of 5 \ifb\ events with two \ossf\ dilepton
pairs were selected, with the requirement that the first \dilep\ pair must be composed of electrons or muons and
have a mass $60 < m_{\ll} < 120$ \gev, and the second pair be composed of either
...
\measStatSyst{11.7}{\errSym{0.8}}{\errSym{1.0}} (including 4.4 events from background
...
measurement of the \ZZ\ production \cx\ at \sqrtseq{8} using a dataset of 5.3
\ifb~\cite{CMS:2013oev}, using a very similar analysis to the \sqrtseq{7} measurement. They
measured the \cx\ to be  \crossSec{p
p\ra
ZZ}{\measStatSystLumi{8.4}{\errSym{1.0}}{\errSym{0.7}}{\errSym{0.4}}\,pb}, in
agreement with the \sm\ prediction of 7.7 \errSym{0.4}~pb.
