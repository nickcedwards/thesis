...
\centering
    ...
    \subfigure[]{
        ...
        \vspace{-2mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{GeneratorComparison/_lep_1_pt_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{GeneratorComparison/_lep_1_eta_lin}
    }
        \vspace{-2mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{GeneratorComparison/_lep_4_pt_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{GeneratorComparison/_lep_4_eta_lin}
    }
        \vspace{-2mm}
    \caption{\small Comparison of generator level distribtuions, normalised to
    unit area, for \ZZsllll\ proceeding via $qq$ and $gg$ interactions. One \Z\ is required to have \sstooos\ and the other
