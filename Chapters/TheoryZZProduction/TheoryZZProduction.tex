...
OPAL~\cite{Abbiendi:2000kq} use the $\cos_{\theta_{Z}}$ distribution, where
...
varying each parameter independently holding the others at zero; two parameter
fits are also carried out. No deviations from the \sm\ are observed. The
log-likelihood distributions from each of the experiemnts as well as the
combined log-likelihood is shown in~\fig{lep-tgc}.
