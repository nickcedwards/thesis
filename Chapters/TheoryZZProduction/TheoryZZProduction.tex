...
~\fig{gen-comp-7-8-ZZ} shows Comparison of distributions at 7 \tev\ and 8 \tev.
...
\centering
    ...
    \tev\ and 8 \tev. Both \Z\ bosons are required to have \sstooos. Figures (a)
...
\centering
    ...
    \tev\ and 8 \tev. One \Z\ is required to have \sstooos\ and the other
...
\centering
        \vspace{-5mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZ_ZZ_m_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZ_ZZ_pt_lin}
    }
        \vspace{-2mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZ_Z1_pt_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZ_Z2_pt_lin}
    }
        \vspace{-2mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZ_lep_1_pt_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZ_lep_1_eta_lin}
    }
        \vspace{-2mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZ_lep_4_pt_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZ_lep_4_eta_lin}
    }
        \vspace{-2mm}
    \caption{\small Comparison of generator level distribtuions, normalised to
    unit area, for \ZZllll\ proceeding via $qq$ and $gg$ interactions. Both \Z\ bosons are required to have \sstooos. Figures (a)
    and (b) show the mass and \pt\ of the \ZZ\ system,
    respectively. Figures (c) and (d) show the \pt\ of the
    leading and subleading \Z, respectively. Figure (e) shows the \pt\ of the highest \pt\ lepton in the event, and figure (f) shows its
   $\eta$. Similarly figures (g) and (h) show the \pt\ and $\eta$ of the lowest
...
\centering
        \vspace{-5mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZs_ZZ_m_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZs_ZZ_pt_lin}
    }
        \vspace{-2mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZs_Z1_pt_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZs_Z2_pt_lin}
    }
        \vspace{-2mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZs_lep_1_pt_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZs_lep_1_eta_lin}
    }
        \vspace{-2mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZs_lep_4_pt_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{Compareggqq/truth_ZZs_lep_4_eta_lin}
    }
        \vspace{-2mm}
    \caption{\small Comparison of generator level distribtuions, normalised to
