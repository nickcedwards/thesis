...
Since the departure from the SM prediction grows rapdily with \sqrts\ and may
...
\begin{align}
\fiV(\shat) = \frac{\fiV_{0}}{(1 + \shat / \Lambda)^{n}}
\end{align}

where $i=4,5$, $V=Z,\gamma$ and $\Lambda$ is taken to be the scale at which the
new physics becomes directly observable.
