...
three final states \eeee, \mumumumu\ and \eemumu. The
branching fractions to this final states are as follows:

\begin{eqnarray}
\mathcal{B}(\ZZeeee) = 0.113 \errSymm{0.008} \% \\
\mathcal{B}(\ZZmmmm) = 0.113 \errSymm{0.014} \% \\
\mathcal{B}(\ZZeemm) = 0.226 \errSymm{0.016} \% \\
    \end{eqnarray}
