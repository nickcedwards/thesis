...
\centering
        \vspace{-5mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{GeneratorComparison/fidZZ_ZZ_m_2e2mu_wRatio_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{GeneratorComparison/fidZZ_ZZ_pt_2e2mu_wRatiolin}
    }
        \vspace{-2mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{GeneratorComparison/fidZZ_Z1_pt_2e2mu_wRatiolin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{GeneratorComparison/fidZZ_Z2_pt_2e2mu_wRatiolin}
    }
        \vspace{-2mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{GeneratorComparison/ZZ_lep_1_pt_wRatio_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{GeneratorComparison/ZZ_lep_1_eta_wRatio_lin}
    }
        \vspace{-2mm}
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{GeneratorComparison/ZZ_lep_4_pt_wRatio_lin}
    }
    \subfigure[]{
        \includegraphics[width=0.47\textwidth]{GeneratorComparison/ZZ_lep_4_eta_wRatio_lin}
    }
        \vspace{-2mm}
    \caption{\small Comparison of generator level distribtuions, normalised to
    unit area, for \ZZsllll\ proceeding via $qq$ and $gg$ interactions. One \Z\ is required to have \sstooos\ and the other
