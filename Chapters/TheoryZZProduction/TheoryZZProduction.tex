...
\small
          ...
          & \multicolumn{2}{c}{$\sigma(ee\mu\mu)$~(fb)} &\multicolumn{2}{c}{Value shift (\%)}  & \multicolumn{2}{c}{$\sigma(ee\mu\mu)$~(fb)} &\multicolumn{2}{c}{Value shift (\%)}\\
          &            & \partDF       & Scale  &            & \partDF       & Scale  \\
\hline
Zero-width  &14.626$\pm$0.010 &14.146$\pm$0.012 &$^{+3.5}_{-3.2}$ &$^{+4.6}_{-3.3}$ \\
\hline
$66<m_{12}<116$~GeV   &13.924$\pm$0.011 &13.462$\pm$0.011 &&$^{+4.6}_{-3.3}$ \\
$66<m_{34}<116$~GeV   &&&& \\
\hline
$66<m_{12}<116$~GeV   &9.484$\pm$0.013 &9.113$\pm$0.011 &$^{+3.5}_{-4.0}$ &$^{+4.8}_{-3.4}$ \\
$66<m_{34}<116$~GeV   &&&& \\
$\pT(\ell)>7$~GeV, $|\eta(\ell)|<3.16$, $\dR<0.2$ &&&& \\
\hline        
$66<m_{12}<116$~GeV   &17.382$\pm$0.021 &16.812$\pm$0.023 &$^{+4.0}_{-2.69}$ &$^{+4.38}_{-3.4}$ \\
$m_{34}>20$~GeV       &&&& \\
\hline
$66<m_{12}<116$~GeV   &11.176$\pm$0.016 &10.715$\pm$0.016 &$^{+5.1}_{-3.7}$ &$^{+5.2}_{-3.25}$ \\
$m_{34}>20$~GeV       &&&& \\
$\pT(\ell)>7$~GeV, $|\eta(\ell)|<3.16$, $\dR<0.2$ &&&& \\
\hline
          &\multicolumn{2}{c}{$A_{ZZ}$} &\multicolumn{2}{c}{Fractional error (\%)} \\
          &MSTW2008           &CTEQ6.6       &CTEQ6.6 error set &Scale \\
\hline
          &0.6484$\pm$0.0010  &0.6442$\pm$0.0009 &$^{+0.65}_{-1.41}$ &$^{+0.18}_{-0.10}$ \\ 
\hline
\end{tabular}
\end{center}
