...
\begin{itemize}
    ...
    \item \herwigPP
    \item \mcatnlo . Used to simulate the background processes \ttbar, \Wt
...
\begin{itemize}
    \item \alpgen is used to simulate the production of \W\ and \Z\ bosons in
