...
calculate a total cross section. Alternatively, the natural width of the \Z\
bosons can be used, and requirements made on the invarient masses of the \Z\
bosons to define a cross section. In this thesis, two total \ZZ\ cross sections
are presented: an \intro{on-shell} cross section, assuming natural width for the
\Z\ boson and requiring both bosons have mass in the range \sstooosZ, and a
cross section allowing one of the \Z\ bosons to be off shell with $m_{\Z}>20$
\gev.
