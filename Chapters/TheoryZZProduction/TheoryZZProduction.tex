...
\centering
    \subfigure[]{
        ...
        \fmf{fermion}{v4,v2}% + top of box --> correct
            \fmf{gluon}{v2,i2}
        \fmf{fermion}{v2,v1,tension=0}% + left hand side of box correct
            \fmf{fermion}{v3,v4,tension=0} % + right hand side of box
            % uncommment this line if you want dots at the vertices
            %\fmfdotn{v}{4}
        \end{fmfgraph*}
        \end{fmffile}
    ...
    \subfigure[]{
        ...
        \fmf{fermion}{v4,v2}% + top of box --> correct
            \fmf{gluon}{v2,i2}
        \fmf{fermion}{v2,v3}% Diagonal Top L to bottom R
            \fmf{fermion}{v1,v4} %Diaganol Bottom L to top R 
            % uncommment this line if you want dots at the vertices
            %\fmfdotn{v}{4}
        \end{fmfgraph*}
        \end{fmffile}
