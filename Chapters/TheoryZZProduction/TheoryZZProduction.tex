...
loops arising from a new generation of fermions. New heavy fermions arise
...
\centering
    ...
    \subfigure{
        ...
        \fmflabel{$Z$}{o1}
        \fmflabel{$Z$}{o2}
        \fmf{photon,tension=0.5}{i1,v1}
        \fmf{photon,tension=0.5}{v2,o1}
        \fmf{photon,tension=0.5}{v3,o2}
        \fmf{fermion,label=$F$}{v1,v2}
        \fmf{fermion,label=$F$}{v2,v3}
        \fmf{fermion,label=$F$}{v3,v1}
        % uncommment this line if you want dots at the vertices
            %\fmfdotn{v}{4}
        \end{fmfgraph*}
        \end{fmffile}
