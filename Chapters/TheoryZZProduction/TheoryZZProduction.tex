...
Production of pairs of \Z\ bosons, so called `diboson \ZZ\ production' is a
...
as it provides a precision test of the standard model, and unique opportunity to
...
models~\cite{Ellison:1998}.  Standard Model \ZZ\ production is also the
irreducible background to \HZZ\ decays, one of key channels Higgs boson physics
atthe LHC. CMS and ATLAS both recently reported the discovery of a new scala~\cite{HZZ4l_5fb:CERN-PH-EP-2012-014}. It is thus
important to understand the non-Higgs \ZZ\ production in order to make search
for the Higgs and 
