...
6.4~\ifb\ of data in the \ZZllll\ channel~\cite{Abazov:2011td} and 8.6~\ifb\ in the
...
\measStatSyst{54.5}{\errSym{0.3}}{\errSym{4.8}}. In the $2\ell2\tau$ channels,
...
are set on aTGCs using the observed four-lepton mass distribution for the
...
[-0.30, 0.28] \\
CMS & $\inf, -$ & [-0.011, 0.012]  & [-0.012, 0.012]   & [-0.013, 0.015]  &
[-0.014, 0.014] \\
\hline\hline
\end{tabular}
\end{center}
