...
\renorm\ scales are set to the mass of the four-lepton system; in \ggtwoZZ\ they
are set to \mZ. Both samples are normalised to the \cx\ predicted by MCFM using
the CT10 \partDF\ set and scale set to half the mass of the four-lepton system,
