...
\centering
    ...
    shows the invarient mass distribution for the dilepton pair, whilst Figure 
    (b}) \la bel{sfig:hgen-ocom-ZZ \ed{fgure}
...
\centering
    ...
    \subfigure[]{
        ...
        \vspace{-2mm}
    \caption{\small Comparison of generator level distributions, normalised to
    unit area, for \ZZ $\ra\eemm$ proceeding via $qq$ and $gg$ interactions. One 
    \Z\ is required to have \sstooos\ and the other
    $m_{Z}>20$ \gev. Figures (a)
    and (b) show the mass and \pt\ of the \ZZ\ system,
    respectively. Figures (c) and (d) show the \pt\ of the
    leading and subleading \Z, respectively. Figure (e) shows the \pt\ of the highest \pt\ lepton in the event, and figure (f) shows its
   $\eta$. Similarly figures (g) and (h) show the \pt\ and $\eta$ of the lowest
   \pt\ lepton in the event.}
    \label{fig:gen-comp-SherpaQED-ZZs}
\end{figure}
...
different way. For all of the other generators compared in~\fig{gen-comp-ZZs}, 
...
use the $(\llll)$ approach. ~\fig{gen-comp-SherpaQED-ZZs} shows the difference 
between the \Z\
