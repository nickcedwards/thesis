...
Measurements of the \ZZ\ production cross section in $e^+e^-$ collisions have
...
uncertainties~\cite{bib:LEPEW2006}. The resulting combined cross-sections as a
...
\centering
    ...
    \caption{Measurements of the \ZZ\ production cross-section in  $e^+e^-$
...
\ZZ\ cross sections, as well as kinematic distributions sensitive to to aTGCs.
...
each decay channels. Each experiment first combines its limits across across the different
...
both the D0 and the CDF experiments. D0 measured the \ZZ\ cross section in
...
channels, the measured cross-section for on-shell \ZZ\ production was
...
also in good agreement with \sm\ predictions. 

D0 have also set limits on aTGCs
using \ZZllll\ decays in 1~\ifb\ of data~\cite{Abazov:2007ad}, requiring that
