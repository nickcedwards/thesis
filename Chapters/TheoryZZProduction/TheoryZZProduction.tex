...
treatment leaves the mass of each dilepton pair invariant, whereas the latter only
...
lineshape in \sherpa\ samples generated using the two approaches. It is not  clear which is the correct approach
