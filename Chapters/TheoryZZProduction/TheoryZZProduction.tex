...
\centering
    ...
    \subfigure[]{
        ...
        \fmf{fermion}{v4,v2}% + top of box --> correct
            \fmf{gluon}{v2,i2}
        \fmf{fermion,tension=0}{v2,v3}% Diagonal Top L to bottom R
            \fmf{fermion,tension=0}{v1,v4} %Diaganol Bottom L to top R 
            % uncommment this line if you want dots at the vertices
            %\fmfdotn{v}{4}
        \end{fmfgraph*}
        \end{fmffile}
    ...
    enddef;}
        ...
        \fmf{fermion}{v1,v3}% + bottom of box --> correct
        \fmf{fermion}{v4,v2}% + top of box --> correct
        \fmf{tomion,tension=0}{v2,v1}% + left hand side of box correct
        \fmf{tomion,tension=0}{v3,v4} % + right hand side of box
        %Outging Z
