...
The fiducial \cx\ at \sqrtseq{7}, requring both \leppair s to have \sstooos, measured in a
...
\end{align}
At \sqrtses{8}, the fiducial \cx\ measured in a dataset corresponding to an integrated luminosity of
...
branching fractions. The total \cx\ it \sqrtseq{7} was measured to be:
\begin{align}
