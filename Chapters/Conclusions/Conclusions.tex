...
\modetalt{3.16} and be separated from any other lepton with a minimum separation
of \deltaReq{0.2}. The
...
limits were set on the size of the couplings. The couplings are
...
\end{align}
where a \formfactor\ with cutoff scale $\Lambda=3 \tev$ and strength $n=3$ has
been assumed.
