...
of cluster $\eta$ and 11 bins of cluster \et\ from 5 \gev\ to $\gt 80$ \gev.
...
\begin{itemize}
    ...
    \modetalt{2.01} (\modetalt{2.37}) in 2011 (2012). In 2011, at least 1
    ...
    \item {\bf TRT High Threshold Hits} A loose requirement is made of the
    threshold of high-threshold (HT) hits in the TRT detector (see 

\end{itemize}

\subsubsection{\tightPP}
