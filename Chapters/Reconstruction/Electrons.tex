...
resolution observed in data is slightly worse than the simulated resolution; a Gaussian smearing is applied to the simulation to reproduce the resolution observed in the data.
