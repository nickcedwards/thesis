...
\caption{
Distribution of the transverse impact parameter significance for both GSF (open
red) and standard (solid black) truth-matched Monte-Carlo electrons from \Z-boson decays. 
