...
Expected distributions from simulation  these variables in the 2012 reconstruction for real electrons from \Z\ boson
decays and from hadrons reconstructed as electrons are shown in
Figures~\ref{fig:el-id-showershapes-central}
and~\ref{fig:el-id-showershapes-central-2}. Typical values of the cuts ing 2012 for the
