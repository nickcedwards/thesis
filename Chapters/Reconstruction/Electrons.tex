...
\modetalt{1.52}: \Rhad, \Reta. \wetatwo, \Eratio, \wstot, \fthree]{Simulated distributions of variables used in central electron identification. The black
...
\centering
	\subfigure[][$\lambda_{\rm centre}$]{
            \includegraphics[width=0.47\textwidth]{ShowerShapePlots_log/fwd_centerlambda}
        }
	\subfigure[][$\langle \lambda^2 \rangle$]{
            \includegraphics[width=0.47\textwidth]{ShowerShapePlots_log/fwd_long_mom2}
        }
