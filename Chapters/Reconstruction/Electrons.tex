...
for EM calorimeter clusters and matching them to \id\
...
In the forward regions (\modetabetween{2.5}{4.9}) there is no \id\
...
efficiency. This uses \id\ tracks as seeds, which it extrapolates into
...
those of the \Z\ boson. The constant term is extracted by comparing the width of
the Crystal-Ball in the data and the Crystal-Ball in the simulation. Since the
...
shape of the electromagnetic shower in the calorimeter, the quality of the \id\ track, the
