...
taken from \mcsim. The resulting calibration parameters $\alpha_{i}$ are applied
to all reconstructed electrons in the data.The linearity of the response
versus electron energy is checked by applying a similar procedure to electrons
from \JPsiee\ decays (for which the sample is much more statistucally limited).
...
~\fig{el-energy-calib-2011} shows the observed di-electron 
mass distribution for all $\eta$ bins for data taken in 2011. 


\begin{figure}[h]
\centering
            \includegraphics[width=0.8\textwidth]{zee_mass_calibration_2011}
\caption{. Figures from~\cite{ElectronZee2011}.}
