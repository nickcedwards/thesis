...
Gaussian smearing is applied to the simulation to reproduce the resolution
...
Crystal-Ball function in order to determine the resolution. Figures from~\cite{ElectronZee2011}.}
