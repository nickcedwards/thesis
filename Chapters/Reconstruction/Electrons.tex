...
energy loss. The modified \chisqaured\ fitter gives a significant improvement in the track
...
EM calorimeter cluster. Two forms are matching are carried out: the first between the
track parameters extrapolated to the second layer of the calorimeter and the
barycentre of the calorimeter cluster, and the second where the track momentum is
