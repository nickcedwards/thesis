...
\centering
    ...
    optimised in 50 bins of \pt\ and $\eta$. See the text for a description of
    the variables.}
    \label{fig:el-id-showershapes-2}
\end{figure}
...
\centering
    ...
    \caption[Distributions of forward electron identification variables for electrons:
    $\lambda_{\rm centre}$,  $\langle \lambda^2 \rangle$, $\langle r^2 \rangle$,
    $f_{\rm max}$, Normalised longitudinal moment, Normalised lateral moment]
