...
\caption{(a) Electron identification efficiency in 2011 (open markers) and 2012
(solid markers) as a function of the number of reconstructed primary vertices in
the event. The blue points show the efficiency for the \loosePP\ selection, the
red point for the \mediumPP\ and the green for the \tightPP. (b) Efficiency of
...
indicate predictions from Monte-Carlo. The colour indicated the method used to
measure the efficiency: results from \Zee tag and probe are shown as black
points, results from $\jpsi \ra ee$ in blue and $W \ra e \nu$ in red.
Figures
from
