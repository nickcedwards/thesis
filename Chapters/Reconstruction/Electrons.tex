...
\modetalt{1.52}]{Simulated distributions of variables used in central electron identification. The black
...
reconstrcuted as electrons. Since the shapes of the distributions are different
in the different regions of the calorimeter, only electrons and hadrons with \modetalt{1.52}
are shown}
