...
The four-momentum of the jet is obtained simply by summing the four-momentua of
...
calorimeter cells, as described in~\sec{reco-el-reco}. When constructing the jets, the
...
%calibrate the response of the calorimeter to a hadronic shower by calibrating
...
The \intro{Jet Energy Scale (JES)} correction is
