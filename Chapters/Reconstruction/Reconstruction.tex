...
The inside-out tracking procedure will fail to tracks from photon conversions or
...
the silicon. Further, high energy loss at the outer radii of the SCT may cause
the track to change direction in the bending plane and the extension search to
go in the wrong direction. A complimentary tracking procedure called outside-in
...
tracks~\cite{Baines:683897}. These are then extended back into the
