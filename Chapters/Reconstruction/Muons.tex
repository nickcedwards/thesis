...
are built by opening narrow roads around the L1 trigger chamber hits and
...
the beamline and attempting to combine with an ID track) and \intro{inside-out}
...
threshold used for the primary single muon trigger was 18 \GeV; in 2012 it was
raised to 24 \GeV. The muon trigger is
not sensitive to pile-up, but modifications were required in 2012 in order
...
calculation, and to reduce pileup dependency, must have $|\Delta z_{0}| <$ 6mm, where $\Delta z_{0}$ is the
