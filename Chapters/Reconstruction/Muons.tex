...
~\fig{el-reco-eff} shows the observed reconstruction efficiency for muons
...
\caption{Dimuon mass resolutions for (a) muon tracks measured in the Muon
Spectrometer, (b) muon tracks measured in the Inner Detector (c) Combined muon
tracks. The solid points show the measured values in data collected in 2012. The
Blue points show the resolution in simulation, and the red diamonds show the
resolution after applying muon momentum corrections to the simulation. Figures from~\cite{MuonPerfPlots2012}.}
\label{fig:mu-reco-eff}
\end{figure}
