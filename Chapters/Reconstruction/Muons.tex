...
a tag and probe method on Z boson decays, for Combined and Segment
Tagged muons in the 2011 data, as well as the efficiency predicted by the
Monte-Carlo simulation, as a function of $\eta$ and of \pt. The efficiency is
...
reconstruction efficiency is seen to be almost constant as a function of \pt.
...
\caption{Muon reconstruction efficiency as measured with Z boson decays as a function of the pseudorapidity of the muon in data taking . Figures from~\cite{MuonEfficiency2011}.}
