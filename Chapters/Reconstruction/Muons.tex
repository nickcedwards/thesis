...
~\fig{el-reco-eff} shows the observed reconstruction efficiency for Combined and Segment
...
\centering
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{STACO_loose_id_vs_eta}
        }
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{STACO_loose_id_vs_pt}
        }
\caption{. Figures from~\cite{ElectronEfficiency2012}.}
