...
both \pt\ and $\eta$ good agreement is seen between the \mcsim\ and the data,
...
\caption[Muon reconstruction efficiency in 2011 as a function of the pseudorapidity
and the transverse momentum of the muon for muons reconstructed as either Combined or Segment
Tagged using the \staco\ algorithm. ]{Muon reconstruction efficiency in 2011 as a function of (a) the pseudorapidity
