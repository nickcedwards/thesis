...
The muon momentum resolution is measured in data using \Zmumu\ decays. The width
...
\centering
	\subfigure[]{
            \includegraphics[width=0.475\textwidth]{mu_resolution_2012_MS}
        }
	\subfigure[]{
            \includegraphics[width=0.475\textwidth]{mu_resolution_2012_ID}
        }
	\subfigure[]{
            \includegraphics[width=0.475\textwidth]{mu_resolution_2012}
        }
\caption{M. Figures from~\cite{}.}
\label{fig:mu-reco-eff}
\end{figure}
