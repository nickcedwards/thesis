...
\begin{itemize}
    ...
    muons by looking for calorimeter deposits consistent with a minimum ionising
    particle. No MS tracking is used.
...
useful to extend coverage beyond the coverage of the ID.
