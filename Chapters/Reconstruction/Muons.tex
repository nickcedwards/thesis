...
\begin{equation}
\frac{ \sigma (p) }{ p } = \frac{ p_{0}^{MS} }{ p_{T} } \bigoplus  p_{1}^{MS}
\bigoplus  p_{2}^{MS} \cdot p_{T}
\end{equation}
...
\begin{equation}
\frac{ \sigma (p) }{ p } = p_{1}^{ID} \bigoplus  p_{2}^{ID} \cdot p_{T} {\rm
for} \modetalt{1.9}
\frac{ \sigma (p) }{ p } = p_{1}^{ID} \bigoplus  p_{2}^{ID} \cdot p_{T} \cdot
frac{1}{\tan ^{2} (\theta} {\rm for} \modetagt{1.9}
\end{equation}
