...
efficiency predicted by Monet-Carlo simulation. In figure (a) the efficiency for
calorimeter tagged muons are also shown for \modetalt{0.1}. Figures from~\cite{MuonEfficiency2011}.}
