...
stable as a function of time, indicating that there is no shift in the
...
distributions as a function of time. Similarly to the \deltat\ plots, each point on the graph corresponds to the
width of the Gaussian fit to the module temperature distributions 
 for one stable period. For barrel modules, the temperature is taken as the
   average of the front and back thermistor temperatures.

\fig{sigma-evo-tdiff} shows the width of the \tdiff\
distributions as a function of time (the means are not shown as they are
identically zero by construction). Similarly to the \deltat\ plots, each point on the graph corresponds to the
width of the Gaussian fit to the \tdiff\ distribution (such the distribution shown
in~\fig{tdiff_dist}) for one stable period.

\fig{sigma-evo-tdiff} shows the width and mean of the \deltat\
distributions as a function of time. For the widths, each point on the graph corresponds to the
width of the Gaussian fit to the \deltat\ distribution for one stable period (such the distribution shown
in~\fig{dt_dist});
similarly for the means, each point corresponds to the mean of the Gaussian fit
