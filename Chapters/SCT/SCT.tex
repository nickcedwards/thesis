...
which provides the mechanical structure. The read-out chips are located on a
...
located at one end of the module.  The HV is again provided via the base-board.
