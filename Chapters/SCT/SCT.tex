...
~\fig{evap-cooling} shows a schematic of an SCT barrel cooling loop.
The system uses C$_3$F$_8$ gas, delivered at room temperature in a saturated
liquid state to capillaries
...
The exhaust gas is then compressed, condensed, and returned to the cooling loop.
The temperature of the detector structures is controlled by the boiling pressure
of the liquid, which is controlled by backpressure reqgulators (BPR) located at
the end of the return tubes.

\begin{figure}[h]
\centering
\centering
\includegraphics[width=\textwidth]{{EvaporativeCooling}}
