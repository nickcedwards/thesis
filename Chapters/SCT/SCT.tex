...
$-7^{\circ}$C; this is discussed in more detail below. The SCT and Pixel
sub-detectors use a common evaporative cooling system
; this is described in Section~\label{sec:SCT-CoolingDesc}.
...
damage and prolong their lifetime. The Pixel silicon detectors must be held at
