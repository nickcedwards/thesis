...
\centering
	\subfigure[]{
		\includegraphics[width=0.4\textwidth]{barrel_module_diagram}
	}
	\subfigure[]{
		\includegraphics[width=0.45\textwidth]{ec_module_diagram}
	}
...
diagram of the layout of barrel and endcap modules. Barrel modules are constructed
...
polyimide hybrid wrapped around the outside of the module. The HV is applied
