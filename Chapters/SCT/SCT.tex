...
on the graph corresponds to the width of the Gaussian fit to the module
...
of the 2012 run is attributed to calibration work occuring during the
recomissioning. The width of the temperature distributions are observed to be
