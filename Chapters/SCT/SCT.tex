...
caused by excessive heat, it is important to keep the Semiconductor Tracker modules cool,
...
\caption[Diagrams of SCT barrel and endcap modules.]
...
detector control system, \textit{PVSS}~\cite{1748-0221-3-05-P05006}. A data point is written to the Oracle database
every 12 hours for offline analysis. In addition, whenever a module temperature
...
\hline\hline
\end{tabular}
 \caption{The width, goodness of fit and mean of a Gaussian fit to the
...
\begin{figure}
  ...
  \caption[The number of `problematic' modules with large \deltat\ and \tdiff\
...
\begin{figure}[h]
  ...
  time for module Q2/B5/L102/I/P24/C3 and for module Q4/ECA/D4/L160/RO/07 between
...
width of the Gaussian fit to the \deltat\ distribution for one stable period
(such as the distribution shown
