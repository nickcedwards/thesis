...
and energies in the forward region, and also allows a lower high field voltage than a single
electrode design.

\subsection{Forward Calorimeter}

The forward calorimeter (FCAL) covers \modetabetween{3.1}{4.9}. To reduce the
netron flux, the FCAL begins 1.2 m away from the Clectromagnetic calorimeter
front face. Due to the high particle fluxes and energies in the forward region,
the calorimeter must contain relatviely long showers in a small volume allowed
...
passive material. The second two compartments are designed for hadronic
