...
\caption{Peak instantaneous luminosity per run as a function of time in (a)~2011 
and (b)~2012. Figures from~\cite{atlaslumipublic}.}
...
$N_{\rm{b}}$ (max) & 1.15 $\times 10^{11}$ & 1.5 $\times 10^{11}$ & 1.6 $\times 10^{11}$  \\
$n_{\rm{b}}$ (max) & 2808 & 1380 & 1380 \\
Bunch spacing & 25 ns & 50 ns & 50 ns \\
$\beta^{*}$ (m)  & 0.55 m & 1.0 m & 0.6 m \\
$\epsilon_{n}$ (m) & 3.75 \micro m & 1.9-2.3 \micro m & 1.7 - 3.0 \micro m  \\
Peak $\mathcal{L}$ ($\rm{cm}^{-2}\rm{s}^{-1}$) (max) & 1.0 $\times 10^{34}$  & 3.6 $\times 10^{33}$  & 7.7 $\times 10^{33}$ \\
\hline\hline
\end{tabular}
