...
No. particles per bunch & 1.15 $\times 10^{11}$ & 1.4 $\times 10^{11}$  &  1.6 $\times 10^{11}$  \\
Number of bunches per beam & 2808 & & 1374 \\
Bunch spacing & 25 ns & 50 ns & 50 ns \\
Peak Luminosity & 1.0 $\times 10^{34} \rm{cm}^{-2}\rm{s}^{-1}$ & 3.6 $\times
10^{33} \rm{cm}^{-2}\rm{s}^{-1}$  & 7.3 $\times 10^{34} \rm{cm}^{-2}\rm{s}^{-1}$ \\
\hline\hline
\end{tabular}
