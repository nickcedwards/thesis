...
\centering
	\subfigure[]{
            \includegraphics[width=0.48\textwidth]{peakLumiByFill2011}
        }
	\subfigure[]{
            \includegraphics[width=0.48\textwidth]{peakLumiByFill2012}
        }
\caption{Peak instantaneous luminosity per run as a function of time in (a)
2011 and (b) 2012. Figures from~\cite{atlaslumipublic}}.
...
\centering
	\subfigure[]{
            \includegraphics[width=0.48\textwidth]{sumLumiByDay2011}
        }
	\subfigure[]{
            \includegraphics[width=0.48\textwidth]{sumLumiByDay2012}
        }
\caption{Cummuative integrated luminosity run as a function of time in (a)
2011 and (b) 2012. The totals for the two years are separate. Figures from~\cite{atlaslumipublic}}.
\label{fig:atlas-det-1}
\end{figure}

\fig{lhc-inst-lumi} shows the
instantaneous luminosity as measured by ATLAS as a function of time in 2011 and
2012. Figure~\fig{lhc-int-lumi} shows the commulative integrated luminosity
...
$\beta^{*}$   & 0.55 m & 1.0 m & 0.6 m \\
$\epsilon_{n}$ & 3.75 \micro m & 1.9-2.3 \micro m & 1.7 - 3.0 \micro m  \\
