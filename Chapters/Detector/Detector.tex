...
cover \modetalt{2.7} and consist of three layers. 
%The mechanical isolation of
%the sensor wire in each tube from it's neighbours give a reliable system design.
In the innermost layer, for \modetabetween{2.0}{2.7} the MDT are replaced by the
CSC due to the higher rates and higher backgrounds in this region. The CSC are 
multiwire proportional chamber, and so give a higher granularity than the MDT
...
observed interaction rate per bunch crossing $\mu_{vis}$~\cite{ATLAS-CONF-2011-116,Aad:2011dr}. \eqn{lumi-meas-1} can
