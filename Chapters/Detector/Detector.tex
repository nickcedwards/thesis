...
collisions will occur at a rate of approximately 100 MHz. The rate at which a particular
...
they are generally not collided head on), $\epsilon_{n}$ is the beam emittance,
...
\caption{Cumulative integrated luminosity per run as a function of time in (a)
...
2012. Figure~\fig{lhc-int-lumi} shows the cumulative integrated luminosity
