...
cover \modetalt{2.7} and consists of three layers, referred to as
\intro{stations}. Each station consists of two \intro{mulitlayers} formed of
three of four layers of tubes, sandwiched between layers of RPC or TGC
%The mechanical isolation of
%the sensor wire in each tube from it's neighbours give a reliable system design.
In the innermost layer, for \modetabetween{2.0}{2.7} the MDT are replaced by 
