...
\end{equation}
where $\sigm_{vis}=\epsilon \sigma_{inelastic}$ is the total inelastic \cx\
...
$\Epsilon_{x},\Epsilon_{y}$. The bunch charge product is measured by XX. By
...
and~\ref{eqn:lumi-meas-3} a measurement of $\sigma_{vis}$ is obtained.
