...
\begin{equation}
\mathcal{L} = \frac{ \mu n_{b} f_{r} }{ \sigma_{inelastic} }
...
\begin{equation}
\mathcal{L} = \frac{ \muVis n_{b} f_{r} }{ \sigmaVis }
...
\begin{equation}
\mathcal{L} = \frac{ n_{b} f_{r} n_{1} n_{2}}{ 2 \pi \Sigma_{x} \Sigma{y} }
...
$\Sigma_{x},\Sigma_{y}$. The bunch charge product is measured by two DC
