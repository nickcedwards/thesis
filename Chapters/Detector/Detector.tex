...
\begin{figure}[h]
\centering
            \includegraphics[width=0.9\textwidth]{lumivstime}
%	\subfigure[]{
...
%        }
\caption{Peak instantaneous luminosity delivered by the LHC per run as a function of time in from
2012 to 2012. Figures from~\cite{atlaslumipublic}.}
