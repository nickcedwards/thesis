...
calorimtere; thus it can be fully detected. Hadronic showers involved many more
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{{0803015_01}.jpg}
...
in~\fig{calo-cutaway}. The calorimeters cover the range \modetals{4.9}. Over the
