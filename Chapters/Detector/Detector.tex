...
\hline\hline
Parameter & Design~\cite{Brüning:782076} & 2011 Operation & 2012 Operation \\
\hline
Proton Energy & 7 \tev\ & 3.5 \tev\ & 4 \tev \\
No. particles per bunch (peak) & 1.15 $\times 10^{11}$ & 1.6 $\times 10^{11}$ & 1.6 $\times 10^{11}$  \\
Number of bunches per beam (peak) & 2808 & 1380 & 1380 \\
Bunch spacing & 25 ns & 50 ns & 50 ns \\
Peak Luminosity & 1.0 $\times 10^{34} \rm{cm}^{-2}\rm{s}^{-1}$ & 3.6 $\times
10^{33} \rm{cm}^{-2}\rm{s}^{-1}$  & 7.7 $\times 10^{34} \rm{cm}^{-2}\rm{s}^{-1}$ \\
\hline\hline
\end{tabular}
 \caption{LHC operational parameters. A comparison is made of the nominal design
 parameters, and those used in 2011 operation and in 2012 operation.}
