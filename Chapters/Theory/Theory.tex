...
\intro{gravitational force}, the \intro{electromagnetic force}, the \intro{
strong force} and the \intro{weak force}. 
...
atoms to form more complicated structures and for light. It is mediated by the photon ($\gamma$), which couples to
particles carrying electrical charge, with a strength given by the particles
electrical charge and coupling strength $\alpha=1/137$. The photon is a massless
, chargeless spin-1 particle.
...
and an electrically charged lepton with charge -1 (the `electron' $e^{-1}$, `muon' $\mu^{-1}$ and
