...
where $v = \mu / \sqrt{\lambda}$. Terms can also be
...
Such an interaction is called the `Yukawa interaction'. The couplings are
proportional to the Yukawa couplings, which can be different for each
