...
hypercharge and \sutwo\ operators as needed, and are as follows:

\begin{align}
\Dmu & =  \partial_{\mu} + +ig{\bf T^{a}}\Wmu^{a} + ig'Y(\lL)\Bmu & \intertext{for \lL} \\
\Dmu & =  \partial_{\mu} + ig'Y(\lL)\Bmu & \rm{for \eR} \\
\end{align}
