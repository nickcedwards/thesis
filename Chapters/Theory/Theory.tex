...
In proton-proton collisions at particle colliders such as the LHC, it is not the
protons themselves that interact but the quark and gluon constituents of the
proton. In a basic picture, the proton consist of three \intro{valence quarks};
...
probe used to probe the proton, the more sea quarks and gluons `seen', as one
is able to resolve the structure of the proton on a finer level. The content of
...
proton must thus be described by fits to experimental data.
\intro{Parton Density Functions
...
split into further particles. Once the outgoing quarks and gluons become far enough from
...
multiple collisions are collectively referred to as the \intro{Underlying Event
(UE)}.~\fig{pp-event} shows a sketch of a proton-proton collision.
...
\centering
    ...
    \caption{\small
Sketch of a proton-proton collisions. Figure from~\cite{Campbell:2006wx}.
}
    \label{fig:pp-event}
\end{figure}
