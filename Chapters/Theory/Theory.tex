...
\intro{factorisation scale, \uF}, at which
...
A second scale involved in the generation of events, in addition to the factorisation scale \muF\ described
in~\sec{Theory-ppInteractions}, is the
