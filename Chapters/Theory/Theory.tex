...
In the 1960s Weinberg~\{PhysRevLett.19.1264} and Salam~\cite{Salam1964168} proposed the unification of the electromagnetic
...
F^{a\,\mu\nu} \\
i \bar{\lL}^{T} \gammamu \Dmu^{\lL} \lL + i  \bar{\eR}^{T} \gammamu
\Dmu^{\eR} \eR + i \bar{\nuR}^{T} \gammamu \Dmu^{\nuR} \nuR
\end{align}
