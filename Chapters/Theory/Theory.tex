...
charge $Q$. The \Z\ boson couples to left- and right-handed electrons and to
...
written in terms of the physical fields \Wpmmu, \Zmu, \Amu\ can be written as

\begin{equation}
\Dmu  =  \partial_{\mu} + i \frac{g}{\sqrt{2}} ( \Wpmu + \Wmmu ) 
+ i \frac{g}{\cos{\thetaW}} ( I_{3} - \sin^{2}{\thetaW} ) \Zmu
+ i g \sin{\thetaW} Q \Amu
\label{eqn:ew-covariant-derivative-full}
\end{equation}

for a fermion $f$ possessing a third component of weak isospin $I_{3}_f$
and an electromagnetic charge $Q_f$. The electromagnetic charge can be related
to the hypercharge as $Q = I_{3} + Y$. The second term
in~\eqn{eqn:ew-covariant-derivative-full} describes the weak Charge Current (CC)
