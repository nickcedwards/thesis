...
constituants of hadrons such as protons and neutrons. They carry both color and
electro-weak charge. The leptons have no color charge, but do have electroweak
charge. The quarks and leptons are arranged into three generations, which each
generation having identical quantum numbers but progressively higher mass. Each
...
generations). Each generation of leptons consists of an electrically neutral neutrino
and an electrically charged lepton with charge -1 (the `electron' $e^{-1}$, `muon' $\muon^{-1}$ and
`tau' $\tau^{-}$). Each of the particles has an antiparticle partner, with
identical mass but opposite electrical charge.
