...
hadrons is the \intro{factorisation theorem}~\cite{ellis2003qcd}
, which allows the hard
...
f_{j}(x_{2}, \uF) \\
\times \hat{\sigma}_{i,j\ra X} (x_{1}.P_{1}, \alpha_{s}(\uR^{2}), x_{2}.P_{2},
...
scales to an energy similar to the energy scale $Q$ which characterises the interaction, then
