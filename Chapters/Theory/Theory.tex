...
The Lagrangian for a massless free fermion field $\psi$ is given by the Dirac
Lagrangian:
\begin{equation}
...
\suthree\ is the \intro{colour charge}, so named because the three 
...
emit further QCD radiation known as \intro{initial state radiation (ISR)} 
...
proton be described by fits to experimental data. \intro{Parton Density Functions
...
renormalisation scale, discussed in~\sec{qcd}.
...
choice of \fact\ and \renorm\ scales, \uR\ and \uF, defined in~\sec{Theory-ppInteractions}. Since at
