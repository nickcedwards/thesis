...
\begin{equation}
\sigma(P_{1}, P_{2}) = \Sigma_{i,j} \int dx_{1} dx_{2} $f_{i}(x_{1}, \muF)$
$f_{j}(x_{2}, \muF)$ \hat{\sigma}_{i,j\ra X} (x_{1}.P_{1}, \alpha_{s}(\muR^{2}), x_{2}.P_{2},
\frac{Q^{2}}{\uF}, \frac{Q^{2}}{\uR}
\end{equation}

where $\hat{\sigma}_{i,j\ra X}$ is the partonic cross section for partons $i,j$
scattering to give $X$ and  $f_{i}(x_{1}, \muF)$ are the \partDF s. \muF is the
