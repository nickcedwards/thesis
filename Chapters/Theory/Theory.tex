...
helicity of the particle, that is, its spin projected onto it's direction of
...
The \sutwo\ singlets \eR, \nuR, $u_{R}$ are invariant under \sutwo\
...
- \frac{g}{2\sqrt{2}} \overline{\eL} \gammamu \nuL \Wmmu 
\end{equation}
...
\begin{equation}
g \sin{\theta{W}} \overline{\eL} \gammamu \eL \Au
g \sin{\theta{W}} \overline{\eR} \gammamu \eR \Au
 = g \sin{\theta{W}} \overline{e} \gammamu e \Au
\end{equation}

and finally the \Z\ couples to left- and right-handed electrons and to
neutrinos, with slightly different couplings to the left- and right-handed
electrons:

\begin{equation}
\frac{g}{4 \cos{\theta{W}}} \left( 
\overline{\eL} \gammamu \eR \Zmu - 4 \sin{2}{\thetaW} \overline{\eR} \gammamu \eL \Zmu
- \overline{\nuL} \gammamu \nuL \Zmu
\right)
\end{equation}
