...
\centering
	...
	\subfigure[Selected Forward Electrons]{
            \includegraphics[width=0.47\textwidth]{ffDists8TeV/ForwardEl_pt_L_lin}
        }
	\subfigure[Forward Electron-Like-Jets]{
            \includegraphics[width=0.47\textwidth]{ffDists8TeV/ForwardEl_pt_J_lin}
        }
	\subfigure[Selected Electrons]{
...
in~\tab{bg-est-results-seven} for the `nominal' $J$ definition. The background
estimates under each of the variations described in the previous section are
shown in~\tab{bg-est-syst-seven}. The results are observed to be stable under
