...
\caption{Details of the background estimate for 20~\ifb\ of 8~\tev\ data. The first row
shows the number of observed \NLLLJ\ events; the second row shows this quantity
scaled by the \ffactor\ (applied on an event by event basis). The third row
shows the MC estimated number of \ZZ\ events identified as \LLJJ, scaled by the
...
identifies as \LLLJ\ scaled by the \ffactor. The resulting background estimate
