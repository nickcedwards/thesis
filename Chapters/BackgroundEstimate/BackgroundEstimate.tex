...
66 $ < M_{Z2} < $ 116 GeV   &  0.6  $\pm$ 0.2 & 0.1 $\pm$ 0.1 & $<0.2$ \\ 
  ...
  the \Zjets, \WZ/\WW and \topquark\ backgrounds in the \eeee\ final-state for
  the 7~\tev\ analysis.]
  {MC predicted number of events passing various levels of selection for
  the \Zjets, \WZ/\WW and \topquark\ backgrounds in the \eeee\ final-state for
  the 7~\tev\ analysis. The
...
66 $ < M_{Z2} < $ 116 GeV   &  < 0.3         & $<0.1$           & - \\ 
  ...
  \end{tabular}
  \caption[MC predicted number of events passing various levels of selection for
  the \Zjets, \WZ/\WW and \topquark\ backgrounds in the  \mmmm\ final-state for
  the 7~\tev\ analysis.]
  {MC predicted number of events passing various levels of selection for
  the \Zjets, \WZ/\WW and \topquark\ backgrounds in the \mmmm\ final-state for
  the 7~\tev\ analysis. The
...
66 $ < M_{Z2} < $ 116 GeV   &  0.7  $\pm$ 0.3  & 0.1 $\pm$ 0.1 & $<$ 0.1 \\ 
  ...
  \end{tabular}
  \caption[MC predicted number of events passing various levels of selection for
  the \Zjets, \WZ/\WW and \topquark\ backgrounds in the \eemm\ final-state for
  the 7~\tev\ analysis.]
  {MC predicted number of events passing various levels of selection for
  the \Zjets, \WZ/\WW and \topquark\ backgrounds in the \eemm\ final-state for
  the 7~\tev\ analysis. The
...
66 $ < M_{Z2} < $ 116 GeV   &  1.2  $\pm$ 0.4 & 0.3 $\pm$ 0.1 & $<$ 0.2 \\ 
  ...
  combined for the 8~\tev\ analysis.]
  {MC predicted number of events passing various levels of selection for
  the \Zjets, \WZ/\WW and \topquark\ backgrounds in all \llll\ final-states
  combibned for the 8~\tev\ analysis. The
  \Zjets\ background includes contributions from both light and heavy flavour
  jets. The top quark background includes contributions from \ttbar\ and
  single top. The yields are normalised to 4.6~\ifb.
  }
...
Similarly, the \mc\ estimated backgrounds for the 8~\tev\ analysis are shown
in Tables~\ref{table:mc-bg-4e-eight},~\ref{table:mc-bg-4mu-eight} and
~\ref{table:mc-bg-2e2mu-eight} for the \eeee, \mmmm\ and \eemm\ final-states,
respectively, and in~\tab{mc-bg-4l-eight} for all final-states together. 
...
\hline
         FourLeptons &    $0.0 \pm 0.0$ &    $0.4 \pm 0.1$ &    $4.2 \pm 2.0$ \\
          Quadruplet &    $0.0 \pm 0.0$ &    $0.2 \pm 0.1$ &    $4.5 \pm 1.8$ \\
     66$<M_{01}<$166 &    $0.0 \pm 0.0$ &    $0.2 \pm 0.1$ &    $2.2 \pm 1.2$ \\
     66$<M_{34}<$116 &    $0.0 \pm 0.0$ &    $0.0 \pm 0.0$ &    $0.0 \pm 0.0$ \\
        TriggerMatch &    $0.0 \pm 0.0$ &    $0.0 \pm 0.0$ &    $0.0 \pm 0.0$ \\
            JPsiVeto &    $0.0 \pm 0.0$ &    $0.0 \pm 0.0$ &    $0.0 \pm 0.0$ \\
            \hline\hline
\\
\hline\hline
...
\hline\hline
\end{tabular}
  \caption[MC estimated number of background events passing various levels of selection for
  ...
  8~\tev\ analysis. The top table shows the predicted background to the \eeee\
  final state, the second to the \mmmm\ final state, the third to the \eemm\ and
