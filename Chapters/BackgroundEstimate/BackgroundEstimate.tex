...
\centering
	\subfigure[Selected Central Electrons]{
            \includegraphics[width=0.7\textwidth]{ffDists/CentralEl_pt_L_lin}
        }
	\subfigure[Central Electron-Like-Jets]{
            \includegraphics[width=0.7\textwidth]{ffDists/CentralEl_pt_J_lin}
        }
	\subfigure[Selected Forward Electrons]{
            \includegraphics[width=0.7\textwidth]{ffDists/ForwardEl_pt_L_lin}
        }
	\subfigure[Forward Electron-Like-Jets]{
            \includegraphics[width=0.7\textwidth]{ffDists/ForwardEl_pt_J_lin}
        }
	\subfigure[Selected Electrons]{
            \includegraphics[width=0.7\textwidth]{ffDists/AllEl_eta_L_lin}
        }
	\subfigure[Electron-Like-Jets]{
            \includegraphics[width=0.7\textwidth]{ffDists/AllEl_eta_J_lin}
        }
    \caption[FF dists]{FF dists}
