...
from \WZ\ events. For the 7~\tev\ analysis, the total estimated background due
...
due to fakes is \measStat{5.5}{\errSym{2.8}}. The estimated total irreducible
background is \measStat{1.6}{\errSym{0.1}}. For the 7~\tev\ analysis, no \mc\
samples were available to model the irreducible background. In order to estimate
