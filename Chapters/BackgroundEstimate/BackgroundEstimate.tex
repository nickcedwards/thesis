...
to the \mc. The \ffactors\ are derived from the \mc, and are then applied
...
\hline\hline
    & \eeee & \mmmm & \eemm & \llll \\
\hline
$N_{BG}$ (\FFactor\ method) &  0.83 $\pm$ 0.29 $^{+0.00}_{-0.02}$ &  0.04 $\pm$ 0.02 $^{+0.01}_{-0.01}$ &  0.94 $\pm$ 0.36 $^{+0.01}_{-0.02}$ &  1.81 $\pm$ 0.46 $^{+0.02}_{-0.03}$ \\
$N_{LLLL}$ &  0.69 $\pm$ 0.25 &  0.01 $\pm$ 0.01 &  0.79 $\pm$ 0.28 &  1.49 $\pm$ 0.37 \\
\hline
{\underline \bf 7~\tev, \ZZs\ selection} \\
$N_{BG}$ &  4.22 $\pm$ 0.80 $^{+0.03}_{-0.08}$ &  -0.01 $\pm$ 0.06 $^{+0.02}_{-0.04}$ &  4.54 $\pm$ 0.82 $^{+0.01}_{-0.10}$ &  8.75 $\pm$ 1.15 $^{+0.06}_{-0.21}$ \\
$N_{LLLL}$ &  3.80 $\pm$ 0.92 &  0.06 $\pm$ 0.05 &  4.41 $\pm$ 0.92 &  8.26
$\pm$ 1.30 \\
\hline\hline
\end{tabular}
