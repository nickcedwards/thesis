...
to be considerd a $J$. For forward electrons, pre-leptons are classified as $J$
is the faile the \tight\ ID requirement. A summary of the $J$ definitions is
given in~\tab{J-def}.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lp{6cm}p{6cm}} 
    ...
    %$|\dzerosig|>3.5$)  \\
    Central Muon & Pass Isolation \AND Pass \dzero-significance & (Fail
...
background leptons as the signal sample. This is done by selection of a sample
of evnents containing and \ossf\ \dilep\ pair passing all of the lepton
...
is subtracted using \mc. The pre-leptons are then identified as either $L$ or
