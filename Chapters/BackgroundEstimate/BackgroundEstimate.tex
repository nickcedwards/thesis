...
\ZZSevenTeVMCBgEstRedZZsLLLL; the estimated background to the \ZZ\ selection
is \ZZSevenTeVMCBgEstRedZZLLLL. The total estimated irreducible background
...
due to fakes is~\ZZEightTeVMCBgEstRedZZLLLL and the estimated total irreducible
background is~\ZZSEightTeVMCBgEstIredZZLLLL. 
