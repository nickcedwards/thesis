...
\centering
    ...
    lepton-like-electrons $J$ in the \Z-tag sample.]{\pt\ and $\eta$ distributions for selected electrons $L$ and
    lepton-like-electrons $J$ in the \Z-tag sample. For the \pt\ distribution, central and
    forward electrons are shown separately; for the $\eta$ distributions
    central and forward electrons are shown in the same plot.}
