...
\begin{itemize}
    ...
    of the pair is referred to as the \intro{leading} \Z, and the \Z\ candidate with the
    lower \pt\ is referred to as the \intro{subleading} \Z.

    \item {\bf Primary and Secondary:} The \Z\ candidate closest to the \Z\
    boson mass~\cite{PDG} is referred to as the \intro{primary} \Z; the other
    candidate is referred to as the \intro{secondary} \Z.

\end{itemize}

There is a strong correlation between the \pt\ of the \Z\ boson and the distance
