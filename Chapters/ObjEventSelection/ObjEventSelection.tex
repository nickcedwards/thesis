...
\centering
	\subfigure[]{
            \includegraphics[bb=0 0 1280 960,width=0.7\textwidth]{deltaRcutoffs/truth_fidZZ_mzz_minDR_TGC_F4G0p4.n0.png}
        }
	\subfigure[]{
            \includegraphics[bb=0 0 1280 960,width=0.7\textwidth]{deltaRcutoffs/truth_fidZZ_ptz1_minDR_TGC_F4G0p4.n0.png}
        }
\caption[Affect of \deltaRlt{0.2} requirement on sensitivity to boosted
\fourlep\ systems.]{Affect of \deltaRlt{0.2} requirement on sensitivity to boosted
\fourlep\ systems.}
