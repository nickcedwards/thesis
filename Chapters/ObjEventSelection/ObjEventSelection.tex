...
repaired whilst other developed faults. Additionally, a number of individual cells
were masked in the readout (i.e. have their energy set to zero) due to
...
the first or second sampling layer, the presence of a dead HV region affecting
all
...
primary vertex must be less than 2 mm. The \intro{unbiased} impact parameter is
...
to increase with \pt. This requirement was not applied in 2012.
