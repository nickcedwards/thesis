...
\hline
      & \ZZ\ Selection (7~\tev)     & \ZZs\ Selection  (7~\tev)             &    \\
%Channel & Trigger Efficiency [\%] & Shift when applying SF [\%]\\
%
\hline
                   $eeee$ & 99.69\errSym{0.08}\errSym{x.xx}  & 99.38\errSym{0.10}\errSym{x.xx} & 99.89\errSym{0.02}\errSym{0.03}\\
           $\mu\mu\mu\mu$ & 98.50\errSym{0.15}\errSym{x.xx}  & 97.68\errSym{0.17}\errSym{x.xx} & 98.10\errSym{0.01}\errSym{0.20}\\
               $ee\mu\mu$ & 99.52\errSym{0.07}\errSym{x.xx}  & 99.06\errSym{0.08}\errSym{x.xx} & 99.49\errSym{0.05}\errSym{0.09}\\
                   $llll$ & 99.23\errSym{0.06}\errSym{x.xx}  & 98.67\errSym{0.07}\errSym{x.xx} & 99.14\errSym{0.04}\errSym{0.11}\\
