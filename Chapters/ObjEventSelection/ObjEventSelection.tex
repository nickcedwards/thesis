...
\begin{table}[htbp]
   ...
   \begin{tabular}{l|c|c|c|c}
      ...
      \hline
      $e$ energy scale                    & \ZZSystematicEScaleEEEE    & \ZZSystematicEScaleMMMM    & \ZZSystematicEScaleEEMM    & \ZZSystematicEScaleLLLL    \\
      $e$ energy resolution               & \ZZSystematicESmearEEEE    & \ZZSystematicESmearMMMM    & \ZZSystematicESmearEEMM    & \ZZSystematicESmearLLLL    \\
      $e$ reconstruction efficiency       & \ZZSystematicERecoEEEE     & \ZZSystematicERecoMMMM     & \ZZSystematicERecoEEMM     & \ZZSystematicERecoLLLL     \\
      $e$ identification efficiency       & \ZZSystematicEIdEEEE       & \ZZSystematicEIdMMMM       & \ZZSystematicEIdEEMM       & \ZZSystematicEIdLLLL       \\
      $e$ isolation/z0/d0Sig efficiency   & \ZZSystematicEIsoEEEE      & \ZZSystematicEIsoMMMM      & \ZZSystematicEIsoEEMM      & \ZZSystematicEIsoLLLL      \\
      $\mu$ momentum scale                & \ZZSystematicMuScaleEEEE   & \ZZSystematicMuScaleMMMM   & \ZZSystematicMuScaleEEMM   & \ZZSystematicMuScaleLLLL   \\
      $\mu$ ID momentum resolution        & \ZZSystematicMuIDSmearEEEE & \ZZSystematicMuIDSmearMMMM & \ZZSystematicMuIDSmearEEMM & \ZZSystematicMuIDSmearLLLL \\
      $\mu$ MS momentum resolution        & \ZZSystematicMuMSSmearEEEE & \ZZSystematicMuMSSmearMMMM & \ZZSystematicMuMSSmearEEMM & \ZZSystematicMuMSSmearLLLL \\
      $\mu$ reconstruction efficiency     & \ZZSystematicMuRecoEEEE    & \ZZSystematicMuRecoMMMM    & \ZZSystematicMuRecoEEMM    & \ZZSystematicMuRecoLLLL    \\
      $\mu$ isolation/z0/d0Sig efficiency & \ZZSystematicMuIsoEEEE     & \ZZSystematicMuIsoMMMM     & \ZZSystematicMuIsoEEMM     & \ZZSystematicMuIsoLLLL     \\
      $e$ Trigger                         & \ZZSystematicETriggerEEEE  & \ZZSystematicETriggerMMMM  & \ZZSystematicETriggerEEMM  & \ZZSystematicETriggerLLLL  \\
      $\mu$ Trigger                       & \ZZSystematicMuTriggerEEEE & \ZZSystematicMuTriggerMMMM & \ZZSystematicMuTriggerEEMM & \ZZSystematicMuTriggerLLLL \\
      \hline
      Totals                              & \ZZSystematicRecoTotalEEEE & \ZZSystematicRecoTotalMMMM & \ZZSystematicRecoTotalEEMM & \ZZSystematicRecoTotalLLLL \\
      %\hline\hline
      %\bf{Theoretical Uncertainties to $C_{ZZ}$ }      &  \multicolumn{4}{|c}{} \\
      %\hline
      %$gg\to\ZZ$                          & \multicolumn{4}{|c}{\ZZSystematicGGToZZLLLL}                                                                     \\
      %Generator                           & \multicolumn{4}{|c}{\ZZSystematicGenComparisonLLLL}                                                              \\
      \hline\hline
      \bf{Theoretical Uncertainties to $A_{ZZ}$ (\%)}      &  \multicolumn{4}{|c}{} \\
      \hline
      PDF \& Scale                        & \multicolumn{4}{|c}{\ZZAZZPDFScaleUncPercentage}                                                                 \\
      Effect of Parton Shower             & \multicolumn{4}{|c}{\ZZAZZISRUncPercentage}                                                                      \\
      \hline\hline
      \bf{Luminosity (\%)}                     & \multicolumn{4}{|c}{\ZZLuminosityUncertaintyPercentage}                                                          \\
      \hline\hline
   \end{tabular}
