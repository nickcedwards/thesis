...
Central electrons, with \modetaclusterlt{2.47}, are normally reconstructed using the
...
\centering
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{Dilep8TeV/AllE_Z_m}
        }
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{Dilep8TeV/AllMu_Z_m}
        }
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{Dilep8TeV/AllE_Z_pt}
        }
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{Dilep8TeV/AllMu_Z_pt}
        }
    \caption[ Distributions of relative track and calorimeter isolation, \dzerosig\
    and \zzero\ for additional muons in events containing a dilepton pair with mass
    \sstooos\ in 7~\tev\ data.]
...
\centering
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{Dilep8TeV/AllE_lep_pt}
        }
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{Dilep8TeV/AllMu_lep_pt}
        }
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{Dilep8TeV/AllE_lep_eta}
        }
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{Dilep8TeV/AllMu_lep_eta}
        }
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{Dilep8TeV/AllE_lep_phi}
        }
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{Dilep8TeV/AllMu_lep_phi}
        }
    \caption[ Distributions of relative track and calorimeter isolation, \dzerosig\
    and \zzero\ for additional muons in events containing a dilepton pair with mass
    \sstooos\ in 7~\tev\ data.]
...
\begin{enumerate}
    ...
    the background estimate (see~\chap{Background}). MC predicts that only
