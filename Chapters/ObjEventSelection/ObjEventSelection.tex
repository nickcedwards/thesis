...
and muons get significantly simplified. The reconstruction efficiency is also
slightly lower for the \ZZs\ selection than for the \ZZ\ selection (as much as
6\% in the \eeee\ final state at 7~\tev). This can be attributed to the higher
proportion of leptons at low \pt\ in the \ZZs\ selection, since the lepton
reconstruction and identification efficiency significantly drops off below
20~\gev\ (see, for example~\figs{el-reco-eff}{mu-reco-eff}).
...
di-electron or di-muon pairs from decays of a di-tau pair with an invariant mass near the \Z\
mass will have a lower invariant mass due to the energy carried away by the
neutrinos. There is therefore a higher chance of them passing the looser mass
cut applied in the \ZZs\ selection than passing the \sstooos\ mass cut applied
in the \ZZ\ selection. The contamination from events outside the fiducial phase space is similar in the
\ZZ\ and \ZZs\ selections, at a level of $\sim1\%$.
