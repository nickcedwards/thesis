...
\small
	...
	\hline\hline
        ...
        Closest to Pole             & 5.1 $\pm$ 0.2 & 5.5 $\pm$ 0.2 & \partbox{8em}{7.7  $\pm$ 0.5} \\
        Breit Wigner Probability    & 1.4 $\pm$ 0.1 & 2.9 $\pm$ 0.1 & 10.7 $\pm$ 0.6 \\
        \hline\hline
    \end{tabular}
    \caption{Mis-pairing rates in \% for different algorithms for choosing the
    di-lepton pairs in four lepton events.}
