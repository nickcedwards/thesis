...
\subsection{Contribution from $\ZZ\ra\tau\tau\ell\ell$}
...
\subsection{Contribution from $H\ra\ZZ\ra\tau\tau\ell\ell$}

The ATLAS~\cite{ATLAS_Higgs:2012gk} and CMS~\cite{CMS_Higgs:2012gu} experiments
recently observed a new neutral boson with a mass of around 125~\gev\ with
...
shell. The contribution to the \ZZ\ selection described here from a SM Higgs
boson with mass 125~\gev\ was estimated from \mc. For the on-shell \ZZ\
