...
\begin{enumerate}
    ...
    width equal to the \Z\ width evaluated at the masses of the two dilepton
...
muons prevent any event with muons overlapping with \deltaRlt{0.2} from passing
...
~\fig{objSel-deltaRcutoff} shows the minimum \deltaR\ between any two leptons in
\fourlep\ events in a \mc\ sample at generator level as a function of the mass
of the \fourlep\ system and as a function of the transverse momentum of the
\fourlep\ system. A \ZZllll\ sample generated with aTGCs is used in order to
give statistics at high centre of mass energies, with $\ffourg=0.4$ and no
form-factor applied. The plots show that the \deltaRlt{0.2} cut, applied at
generator level, limits sensitivity to events with $\mZZ>2$~\tev\ and to events
with $\pt(Z1)>900$~\gev.
...
\centering
    ...
    \fourlep\ systems.]{The minimum \deltaR\ between any two leptons in \fourlep\
    events in a \mc\ sample at generator level as a function of (a) mass of the
    \fourlep\ system and (b) transverse momentum of the \fourlep\ system. A \ZZllll\
    sample generated with aTGCs is used in order to give statistics at high centre
    of mass energies, with $\ffourg=0.4$ and no form-factor applied. The
