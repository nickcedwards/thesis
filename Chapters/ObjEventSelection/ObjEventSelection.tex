...
electrons in events with a \dilepton\ pair with \sstooos in 7~\tev\ data. 
...
object and have \ptgt{25}. Any additional electrons in the event are required to pass
...
To motivate the imuon solation, \dzerosig\ and \zzero\ requirements described
above, \fig{objsel-mu} shows the distribution of these variables for additional
muons in events with a \dilepton\ pair with \sstooos in 7~\tev\ data. 
...
the kinematic selection requirements, and the distributions of the isolation, \dzerosig\ and \zzero\
variables for these additional electrons are shown in the plots. As for
electrons, in the
\WZ\ and \ZZ\ processes the additional muons entering the plot are mainly
prompt isolated leptons from \W\ or \Z\ decays. In the \Zll, \ttbar\ and \WW\
processes, the additional muons mainly arise from muons from hadronic decays in
jets or `punch-through' of hadrons to the muon spectrometer. These `background'
muons tend to be less isolated, and
have broader \dzerosig\ and \zzero\ distributions.
...
\caption[ Distributions of relative track and calorimeter isolation, \dzerosig\
and \zzero\ for additional muons in events containing a dilepton pair with
mass \sstooos\ in 7~\tev\ data.]{Distributions of (a) relative calorimeter isolation, (b)
relative track isolation, (c) impact parameter significance \dzerosig\
and (d) longitudinal impact parameter \zzero\ for additional muons in events
containing a \ossf\ \dilepton\ pair with
mass \sstooos\ in 7~\tev\ data. The leptons forming the \dilepton\ pair are required to pass all of
the selection requirements described above, and one must match to the triggering
object and have \ptgt{25}. Additional muons in the event are required to pass
the kinematic selection requirements. Only additional muons after the dilepton pair are plotted. }
\label{fig:objsel-el}
\end{figure}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{l c c c c}
        ...
        \sherpa\    & \ZZSevenTeVCzzZZStatSherpaEEEE\ $\pm$ \ZZSevenTeVCzzSherpaStatZZEEEE 
                    & \ZZSevenTeVCzzZZStatSherpaMMMM\ $\pm$ \ZZSevenTeVCzzSherpaStatZZMMMM
                    & \ZZSevenTeVCzzZZStatSherpaEEMM\ $\pm$ \ZZSevenTeVCzzSherpaStatZZEEMM 
                    & \ZZSevenTeVCzzZZStatSherpaLLLL\ $\pm$ \ZZSevenTeVCzzSherpaStatZZLLLL \\

        \pythia     & \ZZSevenTeVCzzPythiaZZEEEE\ $\pm$ \ZZSevenTeVCzzPythiaStatZZEEEE 
                    & \ZZSevenTeVCzzPythiaZZMMMM\ $\pm$ \ZZSevenTeVCzzPythiaStatZZMMMM
                    & \ZZSevenTeVCzzPythiaZZEEMM\ $\pm$ \ZZSevenTeVCzzPythiaStatZZEEMM 
                    & \ZZSevenTeVCzzPythiaZZLLLL\ $\pm$ \ZZSevenTeVCzzPythiaStatZZLLLL \\

        \hline
        \multicolumn{5}{l}{\bf $gg$ Processes} \\
        \ggtwoZZ    & \ZZSevenTeVCzzggtwoZZZZEEEE\ $\pm$ \ZZSevenTeVCzzggtwoZZStatZZEEEE 
                    & \ZZSevenTeVCzzggtwoZZZZMMMM\ $\pm$ \ZZSevenTeVCzzggtwoZZStatZZMMMM
                    & \ZZSevenTeVCzzggtwoZZZZEEMM\ $\pm$ \ZZSevenTeVCzzggtwoZZStatZZEEMM 
                    & \ZZSevenTeVCzzggtwoZZZZLLLL\ $\pm$ \ZZSevenTeVCzzggtwoZZStatZZLLLL \\
        ...
        PowhegBox   & \ZZSevenTeVCzzPowhegBoxZZsEEEE\ $\pm$ \ZZSevenTeVCzzPowhegBoxStatZZsEEEE 
                    & \ZZSevenTeVCzzPowhegBoxZZsMMMM\ $\pm$ \ZZSevenTeVCzzPowhegBoxStatZZsMMMM
                    & \ZZSevenTeVCzzPowhegBoxZZsEEMM\ $\pm$ \ZZSevenTeVCzzPowhegBoxStatZZsEEMM 
                    & \ZZSevenTeVCzzPowhegBoxZZsLLLL\ $\pm$ \ZZSevenTeVCzzPowhegBoxStatZZsLLLL \\

        \sherpa\    & \ZZSevenTeVCzzZZsStatSherpaEEEE\ $\pm$ \ZZSevenTeVCzzSherpaStatZZsEEEE 
                    & \ZZSevenTeVCzzZZsStatSherpaMMMM\ $\pm$ \ZZSevenTeVCzzSherpaStatZZsMMMM
                    & \ZZSevenTeVCzzZZsStatSherpaEEMM\ $\pm$ \ZZSevenTeVCzzSherpaStatZZsEEMM 
                    & \ZZSevenTeVCzzZZsStatSherpaLLLL\ $\pm$ \ZZSevenTeVCzzSherpaStatZZsLLLL \\

        \pythia     & \ZZSevenTeVCzzPythiaZZsEEEE\ $\pm$ \ZZSevenTeVCzzPythiaStatZZsEEEE 
                    & \ZZSevenTeVCzzPythiaZZsMMMM\ $\pm$ \ZZSevenTeVCzzPythiaStatZZsMMMM
                    & \ZZSevenTeVCzzPythiaZZsEEMM\ $\pm$ \ZZSevenTeVCzzPythiaStatZZsEEMM 
                    & \ZZSevenTeVCzzPythiaZZsLLLL\ $\pm$ \ZZSevenTeVCzzPythiaStatZZsLLLL \\

        \hline
        \multicolumn{5}{l}{\bf $gg$ Processes} \\
        \ggtwoZZ    & \ZZSevenTeVCzzggtwoZZZZsEEEE\ $\pm$ \ZZSevenTeVCzzggtwoZZStatZZsEEEE 
                    & \ZZSevenTeVCzzggtwoZZZZsMMMM\ $\pm$ \ZZSevenTeVCzzggtwoZZStatZZsMMMM
                    & \ZZSevenTeVCzzggtwoZZZZsEEMM\ $\pm$ \ZZSevenTeVCzzggtwoZZStatZZsEEMM 
                    & \ZZSevenTeVCzzggtwoZZZZsLLLL\ $\pm$ \ZZSevenTeVCzzggtwoZZStatZZsLLLL \\
...
\begin{table}[htbp]
    ...
    \begin{tabular}{l c c c c}
        ...
        \sherpa\    & \ZZEightTeVCzzZZStatSherpaEEEE\ $\pm$ \ZZEightTeVCzzSherpaStatZZEEEE 
                    & \ZZEightTeVCzzZZStatSherpaMMMM\ $\pm$ \ZZEightTeVCzzSherpaStatZZMMMM
                    & \ZZEightTeVCzzZZStatSherpaEEMM\ $\pm$ \ZZEightTeVCzzSherpaStatZZEEMM 
                    & \ZZEightTeVCzzZZStatSherpaLLLL\ $\pm$ \ZZEightTeVCzzSherpaStatZZLLLL \\
        ...
        \hline
        \multicolumn{5}{l}{\bf $gg$ Processes} \\
        \ggtwoZZ    & \ZZEightTeVCzzggtwoZZZZEEEE\ $\pm$ \ZZEightTeVCzzggtwoZZStatZZEEEE 
                    & \ZZEightTeVCzzggtwoZZZZMMMM\ $\pm$ \ZZEightTeVCzzggtwoZZStatZZMMMM
                    & \ZZEightTeVCzzggtwoZZZZEEMM\ $\pm$ \ZZEightTeVCzzggtwoZZStatZZEEMM 
                    & \ZZEightTeVCzzggtwoZZZZLLLL\ $\pm$ \ZZEightTeVCzzggtwoZZStatZZLLLL \\
        ...
        \sherpa\    & \ZZEightTeVCzzZZsStatSherpaEEEE\ $\pm$ \ZZEightTeVCzzSherpaStatZZsEEEE 
                    & \ZZEightTeVCzzZZsStatSherpaMMMM\ $\pm$ \ZZEightTeVCzzSherpaStatZZsMMMM
                    & \ZZEightTeVCzzZZsStatSherpaEEMM\ $\pm$ \ZZEightTeVCzzSherpaStatZZsEEMM 
                    & \ZZEightTeVCzzZZsStatSherpaLLLL\ $\pm$ \ZZEightTeVCzzSherpaStatZZsLLLL \\
        ...
        \hline
        \multicolumn{5}{l}{\bf $gg$ Processes} \\
        \ggtwoZZ    & \ZZEightTeVCzzggtwoZZZZsEEEE\ $\pm$ \ZZEightTeVCzzggtwoZZStatZZsEEEE 
                    & \ZZEightTeVCzzggtwoZZZZsMMMM\ $\pm$ \ZZEightTeVCzzggtwoZZStatZZsMMMM
                    & \ZZEightTeVCzzggtwoZZZZsEEMM\ $\pm$ \ZZEightTeVCzzggtwoZZStatZZsEEMM 
                    & \ZZEightTeVCzzggtwoZZZZsLLLL\ $\pm$ \ZZEightTeVCzzggtwoZZStatZZsLLLL \\
