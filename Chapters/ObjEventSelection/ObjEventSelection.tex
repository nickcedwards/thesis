...
\subsubsection{Comparison of reconstruction acceptances at 7~\tev\ and 8~\tev\}
...
the \CZZ\ were re-calculated using a common fiducial volume, defined identically
to the 7~\tev\ fiducial volume, but with the lepton pseudo-rapidity requirements
set to \modetalt{2.5}. Only central electrons and muons were included. The
resulting \CZZ\ are shown in~\tab{objSel-czz-compare}. The acceptance in the
8~\tev\ analysis is significantly greater in the 8~\tev\ analysis compared to
the 7~\tev, particularly in channels involving electrons. This can be attributed
