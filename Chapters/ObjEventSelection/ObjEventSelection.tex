...
the kinematic (\pt,\eta)  and \loosePP\ selection requirements, and the distributions of the isolation, \dzerosig\ and \zzero\
...
\begin{table}[htbp]
    ...
    \begin{tabular}{l c c c c}
        ...
        \sherpa\    & \ZZSevenTeVCzzZZStatSherpaEEEE\ $\pm$ \ZZSevenTeVCzzZZStatSherpaEEEE 
                    & \ZZSevenTeVCzzZZStatSherpaMMMM\ $\pm$ \ZZSevenTeVCzzZZStatSherpaMMMM
                    & \ZZSevenTeVCzzZZStatSherpaEEMM\ $\pm$ \ZZSevenTeVCzzZZStatSherpaEEMM 
                    & \ZZSevenTeVCzzZZStatSherpaLLLL\ $\pm$ \ZZSevenTeVCzzZZStatSherpaLLLL \\
        ...
        \sherpa\    & \ZZSevenTeVCzzZZsStatSherpaEEEE\ $\pm$ \ZZSevenTeVCzzZZsStatSherpaEEEE 
                    & \ZZSevenTeVCzzZZsStatSherpaMMMM\ $\pm$ \ZZSevenTeVCzzZZsStatSherpaMMMM
                    & \ZZSevenTeVCzzZZsStatSherpaEEMM\ $\pm$ \ZZSevenTeVCzzZZsStatSherpaEEMM 
                    & \ZZSevenTeVCzzZZsStatSherpaLLLL\ $\pm$ \ZZSevenTeVCzzZZsStatSherpaLLLL \\
