...
\centering
    ...
    data. ]
    {Figures (a) and (b) show distributions of the \dilepton\ invariant mass for (a) \dielectron\ and 
    (b) \dimuon\ pairs, in events in the 8~\tev\ data containing a pair of
    \osssf\ leptons passing all of the lepton selection criteria described
...
\centering
    ...
    data. ]
    {Kinematic distributions for leptons in events in the 8~\tev\
    data containing an \ossf\ lepton pair passing all of the selection
    requirements described in Sections~\ref{sec:objsel-el}
    and~\ref{sec:objsel-mu}. The \dilep\ pair is required to have \sstooos. 
