...
\hline \hline
Period & Trigger & \pt\ Threshold (GeV) & Luminosity (\ifb) \\
\hline
{ \bf 2011 } & & & \\
...
{ \bf 2012 } & & & \\
A - M & \multicolumn{1}{p{4cm}}{\raggedright \texttt{e24vhi\_medium1} $||$ \texttt{e60\_medium1}} & 24 & \LumiTotalReadyTwentyTwelve \\
\hline
\end{tabular}
\end{center}
