...
object and have \ptgt{25}. Additional electron candidates other than those forming the
...
the selection requirements described above, and one must match to the triggering
object and have \ptgt{25}. Any additional muon candidates in the event are required to pass
...
\centering
    ...
    object with \ptgt{25}. Any additional muon candidates, other than those forming the
...
\begin{itemize}
    ...
    \item {\bf  Isolation/\zzero/\dzero-Significance Efficiency:} The efficiency of the additional
