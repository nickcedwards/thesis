...
pattern (e.g. a single cell in the EM presampler to a 3x3 grid in the second
...
the resolution of the impact paramater and \dzerosig\ are improved, so tighter
...
data; this was not found to increase the misidnetification rate significantly;
