...
includes a contribution from events generated outside the fiducial
volume but
which are reconstructed as within. Since the numerator is not a subset of the
denominator due to these two contributions, \CZZ\ is not a true efficiency. 
