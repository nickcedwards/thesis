...
parameter estimation, but are treated as Stand Alone.

For forward muons with an ID track, a slightly looser set of ID track quality cuts is
applied to the number of hits in the silicon detectors. For data taken in 2011
