...
\small
	 \centering
	 \begin{tabular}{p{3cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}p{1.2cm}}
	 \hline\hline
%	 	 Cutflow & \multicolumn{4}{|c|}{Number of Events} \\ \cline{2-5}
	   & \multicolumn{2}{|c|}{$eeee$} & \multicolumn{2}{|c|}{$\mu\mu\mu\mu$} & \multicolumn{2}{|c|}{$ee \mu \mu$} & \multicolumn{2}{|c}{$llll$} \\
\hline
                                                                                       & $ZZ$ & $ZZ^{*}$ & $ZZ$ & $ZZ^{*}$ & $ZZ$ & $ZZ^{*}$ & $ZZ$ & $ZZ^{*}$ \\
\hline

  Tau contamination (\%)  & 
\ZZTauContaminationPercentageEEEE $\pm$  \ZZTauContaminationPercentageStatEEEE &
\ZZTauContaminationPercentageMMMM $\pm$  \ZZTauContaminationPercentageStatMMMM &
\ZZTauContaminationPercentageEEMM $\pm$  \ZZTauContaminationPercentageStatEEMM &
\ZZTauContaminationPercentageLLLL $\pm$  \ZZTauContaminationPercentageStatLLLL \\
 from $\ZZ \rightarrow \tau+X$   & & & & \\
%%
% % Contaminations from outside fid
% Contamination (\%)   & 
%\ZZOutsideFidContaminationPercentageEEEE $\pm$  \ZZOutsideFidContaminationPercentageStatEEEE &
%\ZZOutsideFidContaminationPercentageMMMM $\pm$  \ZZOutsideFidContaminationPercentageStatMMMM &
%\ZZOutsideFidContaminationPercentageEEMM $\pm$  \ZZOutsideFidContaminationPercentageStatEEMM &
%\ZZOutsideFidContaminationPercentageLLLL $\pm$  \ZZOutsideFidContaminationPercentageStatLLLL \\
%from events outside fiducial region  & & & & \\

% C_ZZ
Reconstruction factor $C_{ZZ}$  & 
\ZZCzzEEEE $\pm$  \ZZCzzStatEEEE &
\ZZCzzMMMM $\pm$  \ZZCzzStatMMMM &
\ZZCzzEEMM $\pm$  \ZZCzzStatEEMM &
\ZZCzzLLLL $\pm$  \ZZCzzStatLLLL \\

%% "True" C_ZZ
%True reconstruction factor      & 
%\ZZTrueCzzEEEE $\pm$  \ZZTrueCzzStatEEEE &
%\ZZTrueCzzMMMM $\pm$  \ZZTrueCzzStatMMMM &
%\ZZTrueCzzEEMM $\pm$  \ZZTrueCzzStatEEMM &
%\ZZTrueCzzLLLL $\pm$  \ZZTrueCzzStatLLLL \\
