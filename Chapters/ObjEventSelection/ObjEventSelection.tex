...
\small
	...
	\hline\hline
        ...
        \ZZCzzZZEEEE $\pm$  \ZZCzzStatZZEEEE &
        \ZZCzzZZMMMM $\pm$  \ZZCzzStatZZMMMM &
        \ZZCzzZZEEMM $\pm$  \ZZCzzStatZZEEMM &
        \ZZCzzZZLLLL $\pm$  \ZZCzzStatZZLLLL \\

          Tau contamination (\%)  & 
        \ZZTauContaminationPercentageZZEEEE $\pm$  \ZZTauContaminationPercentageStatZZEEEE &
        \ZZTauContaminationPercentageZZMMMM $\pm$  \ZZTauContaminationPercentageStatZZMMMM &
        \ZZTauContaminationPercentageZZEEMM $\pm$  \ZZTauContaminationPercentageStatZZEEMM &
        \ZZTauContaminationPercentageZZLLLL $\pm$  \ZZTauContaminationPercentageStatZZLLLL \\
         from $\ZZ \rightarrow \tau+X$   & & & & \\
        %%
         % Contaminations from outside fid
         Contamination (\%)   & 
        \ZZOutsideFidContaminationPercentageZZEEEE $\pm$  \ZZOutsideFidContaminationPercentageStatZZEEEE &
        \ZZOutsideFidContaminationPercentageZZMMMM $\pm$  \ZZOutsideFidContaminationPercentageStatZZMMMM &
        \ZZOutsideFidContaminationPercentageZZEEMM $\pm$  \ZZOutsideFidContaminationPercentageStatZZEEMM &
        \ZZOutsideFidContaminationPercentageZZLLLL $\pm$  \ZZOutsideFidContaminationPercentageStatZZLLLL \\
        from events outside fiducial region  & & & & \\

        % "True" C_ZZ
        True reconstruction factor      & 
        \ZZTrueCzzZZEEEE $\pm$  \ZZTrueCzzStatZZEEEE &
        \ZZTrueCzzZZMMMM $\pm$  \ZZTrueCzzStatZZMMMM &
        \ZZTrueCzzZZEEMM $\pm$  \ZZTrueCzzStatZZEEMM &
        \ZZTrueCzzZZLLLL $\pm$  \ZZTrueCzzStatZZLLLL \\
