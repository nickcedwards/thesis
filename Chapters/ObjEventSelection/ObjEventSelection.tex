...
\small
  \begin{tabular}{ l  l l }
    \hline\hline 
      ...
      Overlap removal       & a) Remove $e$ if $\Delta R < 0.1$ from $\mu$ & \it{Same} \\
                            & b) Remove lowest $E_T$ $e$ in \deltaRlt{0.1} from another $e$ & \it{Same} \\ 
      \hline
      ...
      Overlap removal       & \multicolumn{1}{p{6cm}}{\centering Remove if overlaps with central electron or any muon in \deltaRlt{0.1}} & \it{same}\\
%
      %\bf{Central Electron Selection} & \\
      %Algorthim             & Standard (with GSF refit)     & Standard \\
