...
Cut    & \cutEff\ &  \cutEffNmOne & \cutEff   &  \cutEffNmOne \\
\hline
...
\hline\hline
\end{tabular}
\caption{Efficiency of the central electron selection requirements. The
efficiencies are estimated from \mc\ after applying correction factors to
correct the efficiencies to those observed in data. }
\end{table}
