...
\centering
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{ObjSel/ZplusX/h_CentralEl_etcone20rel_log}
        }
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{ObjSel/ZplusX/h_CentralEl_ptcone20rel_log}
        }
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{ObjSel/ZplusX/h_CentralEl_d0Sig_log}
        }
	\subfigure[]{
            \includegraphics[width=0.47\textwidth]{ObjSel/ZplusX/h_CentralEl_z0_log}
        }
\caption[ Distributions of relative track and calorimeter isolation, \dzerosig\
and \zzero\ for additional leptons in events containing a dilepton pair with
mass \sstooos.]{Distributions of relative track and calorimeter isolation, \dzerosig\
and \zzero\ for additional leptons in events containing a dilepton pair with
mass \sstooos.}
\label{fig:objsel-el}
\end{figure}
