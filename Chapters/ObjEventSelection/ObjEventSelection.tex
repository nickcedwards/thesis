...
\hline
Reconstruction factor $C_{ZZ}$ &  0.428 $\pm$ 0.005 &  0.410 $\pm$ 0.004 &  0.687 $\pm$ 0.004 &  0.679 $\pm$ 0.004 &  0.546 $\pm$ 0.003 &  0.540 $\pm$ 0.003 &  0.552 $\pm$ 0.002 &  0.542 $\pm$ 0.002 \\
Contamination (\%) from $ZZ \rightarrow \tau$+X &  0.37 $\pm$ 0.04 &  2.16 $\pm$ 0.09 &  0.25 $\pm$ 0.03 &  1.53 $\pm$ 0.06 &  0.18 $\pm$ 0.02 &  1.70 $\pm$ 0.05 &  0.24 $\pm$ 0.01 &  1.73 $\pm$ 0.04 \\
Contamination (\%) from events outside fiducial region &  1.04 $\pm$ 0.14 &  1.08 $\pm$ 0.13 &  0.62 $\pm$ 0.09 &  0.53 $\pm$ 0.07 &  0.81 $\pm$ 0.08 &  0.76 $\pm$ 0.07 &  0.80 $\pm$ 0.06 &  0.75 $\pm$ 0.05 \\
True Reconstruction Efficiency &  0.422 $\pm$ 0.005 &  0.398 $\pm$ 0.004 &  0.681 $\pm$ 0.004 &  0.665 $\pm$ 0.004 &  0.541 $\pm$ 0.003 &  0.527 $\pm$ 0.003 &  0.546 $\pm$ 0.002 &  0.529 $\pm$ 0.002 \\

	 \hline\hline
	 \end{tabular}
           \caption{Details of the Monte-Carlo (\powhegbox) selection
           efficiencies and contaminations. The first row shows the percentage
           contamination of events passing the full selection from $\ZZ
           \rightarrow \tau+X$ events. The second row shows the contamination
           ...
           direction being mis-reconstructed. The statistical uncertainty is
           given for the contamination. The third row shows the reconstruction
           factor $C_{ZZ}$, defined as the ratio of the number of events passing
           the selections (including contributions from $\ZZ \rightarrow \tau+X$
           and events outside the fiducial region) to the number of generated
           events in the fiducial region.  The final row shows the ``true''
           reconstruction efficiency, with the contribution from $\ZZ
           \rightarrow \tau+X$ and events outside the fiducial region removed
           from the numerator.
}
          \label{table:CZZcontaminations}
\end{table}
