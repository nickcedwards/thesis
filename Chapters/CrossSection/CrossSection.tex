...
vectors {\bf x} and {\bf y}, where each element represents one bin. The response
function then becomes a response matrix {\bf A}, and one can
...
RooUnfold}~\cite{2011arXiv1105.1160A} package. The algorithm 
