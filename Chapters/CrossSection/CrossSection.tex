...
Fiducial \cx\ results are presented in~\tab{meas-tot-cx}. {\bf Some comment here
on agreement with theory and comparison 7~\tev\ and 8~\tev}.
...
\small
  \begin{tabular}{lll}
    \hline\hline
     & Measured Fiducial \CX   & Theory                              \\
     %7~\tev, \ZZ             &                          \\
    \hline
     {\bf \underline{7~\tev}}             &                          \\
     \sigmaTotZZ\   & \ZZSevenTeVTotalCrossSection & \ZZSevenTeVTheoryTotalCrossSection \\
    \hline
     {\bf \underline{8 \ZZ}}             &                          \\
     \sigmaTotZZ\   & \ZZEightTeVTotalCrossSection & \ZZEightTeVTheoryTotalCrossSection \\
    \hline\hline
  \end{tabular}
