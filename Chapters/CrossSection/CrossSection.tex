...
larger than the detector resolution. Unfolded distributions are only given for
the 7~\tev\ analysis. The unfolded distributions are presented in
...
\begin{figure}[htbp]
\begin{center}
\subfigure[]{\includegraphics[width=0.7\textwidth]{Unfolded/ZZllll_ZpT_natbins_UnfoldedDistribution}}
\subfigure[]{\includegraphics[width=0.7\textwidth]{Unfolded/ZZllll_DPhiLep_natbins_UnfoldedDistribution}}
\subfigure[]{\includegraphics[width=0.7\textwidth]{Unfolded/ZZllll_ZZTMass_natbins_UnfoldedDistribution}}
...
of the leading $Z$ boson, \DeltaPhiLL\ and (c) the four-lepton invariant mass, $m^{ZZ}$. }
\end{center}
\end{figure}
