...
% pT_Z vs dR 7 TeV
 \begin{figure}[htbp]
 \begin{center}
  \includegraphics[width=0.7\textwidth]{7TeV/h_dr_ptz.pdf}\hfill
  \caption[Mass of the leading \leppair versus the mass of the
  sub-leading \leppair for candidate events, passing all of the selection
  requirements apart from the \dilepton\ mass requirements, in the 7~\tev\ data.]
    {Transverse momentum of the \leppair\ candidate versus the angle of the two leptons forming the pair. The events observed in
the data are shown as black dots and the signal prediction as boxes. Two entries per event.
  {\small    }
 \label{fig:mass2d}
 \end{center}
 \end{figure}
