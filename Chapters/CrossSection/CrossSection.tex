...
\begin{figure}[htbp]
    \begin{center}
     \subfigure[]{
     \includegraphics[width=0.48\textwidth]{8TeV/h_4l_ZZ_ZZ_pt}
     }
     \subfigure[]{
     \includegraphics[width=0.48\textwidth]{8TeV/h_4l_ZZ_ZZ_m}
     }
     \subfigure[]{
     \includegraphics[width=0.48\textwidth]{8TeV/h_4l_ZZ_Z1_pt}
     }
     \subfigure[]{
     \includegraphics[width=0.48\textwidth]{8TeV/h_4l_ZZ_Z2_pt}
     }
    \caption[Kinematic distributions for events passing the \ZZ\ selection in
    the 8~\tev\ data.]
    {Kinematic distributions for events passing the \ZZ\ selection in
