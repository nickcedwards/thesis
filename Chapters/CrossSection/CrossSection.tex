...
~\figs{zzdists-Zmass-seven}{zzdists-Zmass-eight} show the invariant mass
dilepton mass distributions for the leading and subleading \leppair\ for the
7~\tev\ and 8~\tev\ data. Similarly 
~\figs{zzdists-ZZ-seven}{zzdists-ZZ-eight} show the transverse momentum $\pT^{\ZZ}$ and invariant mass $m^{\ZZ}$ of the 
four-lepton system, the transverse momentum of the leading
\dilep\ pair $\pt^{Z1}$, and the transverse momentum of the subleading
\dilep\ pair $\pt^{Z2}$, for events passing the \ZZ\ selection for the 7~\tev\ and for the 8~\tev\ analyses,
respectively.~\figs{zzdists-ZZ-seven}{zzdists-ZZ-eight} show the corresponsding
distributions for the \ZZs\ selection. In each case the prediction from \mc\ for
...
is shown as a light blue histogram. The shapes of the distributions are
consistent wit the predictions from \mc.
