...
and 8~\tev\ analyses respectively (ordered in \pt; see~\sec{eventsel-definitions}). In both cases the solid red box
...
shown in~\tab{azz}. The \AZZ\ are smaller for 2012 reflecting the tighter lepton $\eta$ 
requirement in the definition of the fiducial \phasepace.
...
\mZZ. The parallel lines in (a) indicate a discontinuity in the final bin.}
