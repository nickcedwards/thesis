...
% 2D plot, 7 TeV
 \begin{figure}[htbp]
 \begin{center}
  \includegraphics[width=0.7\textwidth]{figures/h_mz1_mz2.pdf}\hfill
  \caption{\small The mass of the leading lepton pair versus the mass of the sub-leading lepton pair.
  ...
  requirements on the lepton-pair masses for $ZZ$ ($ZZ^*$) events, as
  defined in the text. 
