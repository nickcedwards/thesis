...
Exp. Bg. & 
    \ZZSevenTeVNBgZZEEEE~\errSym{\ZZSevenTeVNBgStatZZEEEE}~\errSym{\ZZSevenTeVNBgStatZZEEEE} & 
    \ZZSevenTeVNBgZZMMMM~\errSym{\ZZSevenTeVNBgStatZZMMMM}~\errSym{\ZZSevenTeVNBgStatZZMMMM} & 
    \ZZSevenTeVNBgZZEEMM~\errSym{\ZZSevenTeVNBgStatZZEEMM}~\errSym{\ZZSevenTeVNBgStatZZEEMM} & 
    \ZZSevenTeVNBgZZLLLL~\errSym{\ZZSevenTeVNBgStatZZLLLL}~\errSym{\ZZSevenTeVNBgStatZZLLLL} \\
\hline\hline
    \\
    \hline\hline
...
Exp. Bg. & 
    \ZZSevenTeVNBgZZsEEEE~\errSym{\ZZSevenTeVNBgStatZZEEEE}~\errSym{\ZZSevenTeVNBgStatZZEEEE} & 
    \ZZSevenTeVNBgZZsMMMM~\errSym{\ZZSevenTeVNBgStatZZMMMM}~\errSym{\ZZSevenTeVNBgStatZZMMMM} & 
    \ZZSevenTeVNBgZZsEEMM~\errSym{\ZZSevenTeVNBgStatZZEEMM}~\errSym{\ZZSevenTeVNBgStatZZEEMM} & 
    \ZZSevenTeVNBgZZsLLLL~\errSym{\ZZSevenTeVNBgStatZZLLLL}~\errSym{\ZZSevenTeVNBgStatZZLLLL} \\
    \hline\hline
  \end{tabular}
...
unfolding: the transverse momentum \ptZ\ and \deltaPhiLL\ between the decay leptons
of the leading \Z\ boson, and the four-lepton invariant mass \mZZ. Bin
