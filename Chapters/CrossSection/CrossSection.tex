...
\unfxi\ events in bin $i$ of the true distribution, as a result an observation of
\unfyj\ events in bin $j$ is given by:
\begin{equation}
P(\unfxi|\unfyj,I) = \frac{P(\unfyi|\unfxj,I)\cdot P(\unfxi|I)}{\Sigma_{k}P(\unfyk|\unfxj,I)\cdot P(\unfxk|I)}
\end{equation}
...
be associated as the $i,j$ th element of the unfolding matrix \unfA. Summing
over all of the bins of the observed distribution, the number of counts in
\unfxi\ is thus given by:
\begin{equation}
\unfxi = \frac{1}{\epsilon_{i}} \Sigma^{n}_{j=1} \frac{A_{ji} \cdot P(\unfxi|I)}{\Sigma_k A_{jk} \cdot P(\unfxk|I)}
\end{equation}
