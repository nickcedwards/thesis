...
\begin{equation}
P(\unfxi|\unfyj,I) = \frac{P(\unfyi|\unfxj,I)\cdotP(\unfxi|I)}{\Sigma_{k}P(\unfyk|\unfxj,I)\cdotP(\unfxk|I)}
\end{equation}
...
\begin{equation}
\unfxi = \frac{1}{\epsilon_{i}} \Sigma^{n}_{j=1} \frac{A_{ji} \cdot P(\unfxi|I)}{\Sigma_k A_{jk} \cdotP(\unfxk|I)}
\end{equation}
