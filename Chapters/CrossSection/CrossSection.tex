...
\begin{figure}[htbp]
    \begin{center}
     \subfigure[]{
     \includegraphics[width=0.48\textwidth]{8TeV/h_4l_ZZs_Z1_m}
     }
     \subfigure[]{
     \includegraphics[width=0.48\textwidth]{8TeV/h_4l_ZZs_Z2_m}
     }
    \caption[Invariant masses of the (a) leading and (b) subleading \leppair\
...
\begin{figure}[htbp]
    \begin{center}
     \subfigure[]{
     \includegraphics[width=0.48\textwidth]{8TeV/zzPt}
     }
     \subfigure[]{
     \includegraphics[width=0.48\textwidth]{8TeV/M4l}
     }
     \subfigure[]{
     \includegraphics[width=0.48\textwidth]{8TeV/z1Pt}
     }
     \subfigure[]{
     \includegraphics[width=0.48\textwidth]{8TeV/z2Pt}
     }
    \caption[Kinematic distributions for events passing the \ZZ\ selection in
    the 8~\tev\ data.]
    {Kinematic distributions for events passing the \ZZ\ selection in
...
As discussed in~\sec{sec:TheoryZZProduction-CxDef}, the \cx\ is first measured in a fiducial phase-space
...
fiducial phase-space was given in~\sec{sec:TheoryZZProduction-CxDef}, and is slightly different for the
...
Fiducial \cx\ results are presented in~\tab{meas-fid-cx}
...
\small
  \begin{tabular}{lll}
    ...
    \hline
     ...
     \ZZlplmlplm\   & \ZZSevenTeVFiducialCrossSectionZZLLLL   & \ZZSevenTeVTheoryFiducialCrossSectionZZLLLL \\
    %\hline\hline
    %\\
    %\hline\hline
     %7~\tev, \ZZs             &                          \\
    \hline
     ...
     \ZZslplmlplm\  & \ZZSevenTeVFiducialCrossSectionZZsLLLL & \ZZSevenTeVTheoryFiducialCrossSectionZZsLLLL   \\
    \hline
...
branching fraction. The total \cx\ is defined as with both \Z\ bosons with mass
