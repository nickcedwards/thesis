...
\end{equation}
where the $\Gamma(x; b, \Delta_{b})$ distribution used is the Gamma p.d.f
\begin{equation}
   \mathrm{Gamma}(x; k,\theta) = \frac{1}{{\theta}^k} \frac{1}{\Gamma(k)} x^{k-1} e^{-x/\theta} \, \, \mathrm{for} \,  \, x \ge 0, \, \, \mathrm{and} \, \, k, \theta > 0.
\end{equation}
