...
are observed in \LumiPassGRLTwentyEleven~\ifb\ of 7~\tev data for the \ZZ\ (\ZZs)
selection. In the 8~\tev\ data, which corresponds to an integrated luminosity of
\LumiPassGRLTwentyTwelve~\ifb\~\ZZEightTeVNObsZZLLLL\ (\ZZEightTeVNObsZZsLLLL) events are
observed for the \ZZ\ (\ZZs) selection. 

\section{Kinematic Distributions Events}
...
and the 8~\tev\ abalysis respectively. In both cases the solid red box
