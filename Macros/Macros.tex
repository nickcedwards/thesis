...
% Single Zs, J/psi
\newcommand{{\zee}}{\ensuremath{\ZZ\to e^{-} e^{+}\nu\bar{\nu}}} 
...
% Generators
\newcommand{\ggZZ}{{\sc gg}2{\sc zz}\xspace}
...
\charnewcommand{\letterchar}=11
\charnewcommand{\otherchar}=12
\charnewcommand{\eolinechar}=5
%
% +--------------------------------------------------------------------+
% |                                                                                   
...
\newcommand{\ZZ}{\ensuremath{\Zzero\Zzero}\xspace}
...
\newcommand{\ptsp1}{\ensuremath{p_T} }
\newcommand{\ptnsp}{\ensuremath{p_T}}
...
\newcommand{\MET}{\ensuremath{E_{\mathrm{T}}^{\mathrm{miss}}}} % Sub/superscript roman not italic (EE)
\newcommand{\met}{\ensuremath{E_{\mathrm{T}}^{\mathrm{miss}}}} % Sub/superscript roman not italic (EE)
...
\newcommand{\twomass}#1#2{\ensuremath{m_{#1#2}}}% 
%
