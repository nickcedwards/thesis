...
\newcommand{\ndiv}[3][2]{\FPdiv\p{#2}{#3}\FPupn\p{\p{} #1 round}\FPprint\p}
\newcommand{\nmult}[3][2]{\FPmul\p{#2}{#3}\FPupn\p{\p{} #1 round}\FPprint\p}
\newcommand{\nmultperc}[3][2]{\FPmul\p{#2}{#3}\FPmul\q{\p}{0.01}\FPupn\q{\q{} #1 round}\FPprint\q}
%\newcommand{\averageCzz}[3]{\FPmul\p{#1}{#2}\FPupn\p{\p{} 3 round}\FPprint\p}
\newcommand{\averageCzz}[3]{\FPadd\p{#1}{#2}\FPmul\q{2}{#3}\FPadd\r\p\q\FPdiv\s\r{4}\FPupn\s{\s{} 3 round}\ensuremath{\FPprint\s}}
\newcommand{\addStatSyst}[3][2]{\FPmul\p{#2}{#2}\FPmul\q{#3}{#3}\FPadd\r{\p}{\q}\FProot\s{r}{2}\FPupn\s{\s{}#1 round}\ensuremath{\FPprint\s}}

\newcommand{\fig}[1]{Figure~\ref{fig:#1}}
\newcommand{\figs}[2]{Figures~\ref{fig:#1} and~\ref{fig:#2}}
\newcommand{\eqn}[1]{Equation~\ref{eqn:#1}}
\newcommand{\tab}[1]{Table~\ref{table:#1}}
\newcommand{\tabs}[2]{Tables~\ref{table:#1} nd~\ref{table:#2}}
\renewcommand{\sec}[1]{Section~\ref{sec:#1}}
\newcommand{\app}[1]{Appendix~\ref{appendix:#1}}
...
\newcommand{\ZX}{\ensuremath{\Z+}X}
\newcommand{\Zbb}{\ensuremath{\Z+b\bar b}}
\newcommand{\trilep}{\ensuremath{ZZZ/WWZ}}
\newcommand{\ttbarV}{\ensuremath{\ttbar+V}}
\newcommand{\topquark}{top quark}
\newcommand{\Zgamma}{\ensuremath{\Z+\gamma}}
\newcommand{\lljet}{lepton-like-jet}
\newcommand{\bglepton}{background lepton}
\newcommand{\sellep}{selected-lepton}
\newcommand{\ffactor}{fake-factor}
\newcommand{\fakefactor}{\ffactor}
\newcommand{\FakeFactor}{Fake-Factor}
\newcommand{\FFactor}{\FakeFactor}
\newcommand{\bglep}{background lepton}
\newcommand{\FF}{\ensuremath{FF}}
\newcommand{\f}{\ensuremath{f}}
\newcommand{\frate}{fake rate}
\newcommand{\LLJJ}{\ensuremath{LLJJ}}
\newcommand{\LLLJ}{\ensuremath{LLLJ}}
\newcommand{\NLLJJ}{\ensuremath{N_{LLJJ}}}
\newcommand{\NLLLJ}{\ensuremath{N_{LLLJ}}}
...
\newcommand{\deltaRdef}{\ensuremath{\Delta R = \sqrt{(\Delta \eta)^{2} +(\Delta \phi)^{2}}}}
...
% Isolation iso
\newcommand{\ptconetwentygt}[1]{\ensuremath{{\Sigma \pt(\Delta R < 0.2)/\pt>#1}}}
\newcommand{\ptconetwentylt}[1]{\ensuremath{{\Sigma \pt(\Delta R < 0.2)/\pt<#1}}}
\newcommand{\etconetwentygt}[1]{\ensuremath{{\Sigma \Et^{\rm{calo}}(\Delta R <0.2)/ \pt>#1}}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Unfolding
\newcommand{\unfx}{\ensuremath{\mathbf{x}}}
\newcommand{\unfy}{\ensuremath{\mathbf{y}}}
\newcommand{\unfA}{\ensuremath{\mathbf{A}}}
\newcommand{\unfxi}{\ensuremath{x_i}}
\newcommand{\unfxj}{\ensuremath{x_j}}
\newcommand{\unfxk}{\ensuremath{x_k}}
\newcommand{\unfyi}{\ensuremath{y_i}}
\newcommand{\unfyj}{\ensuremath{y_j}}
\newcommand{\unfyk}{\ensuremath{y_j}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\def\NObslllplp{\ensuremath{N^{\rm obs}_{\lllplp}}}
\def\NBglllplp{\ensuremath{N^{\rm bkg}_{\lllplp}}}
\def\NObs{\ensuremath{N^{\rm obs}}}
\def\NBg{\ensuremath{N^{\rm bkg}}}
...
\def\sigmaFidZZsllll{\ensuremath{{\sigma_{\ZZsllll}^{\rm fid}}}}

\def\sigmaFidTheoryZZllll{\ensuremath{{\sigma_{\ZZllll}^{\rm fid, theory}}}}
\def\sigmaFidTheoryZZsllll{\ensuremath{{\sigma_{\ZZsllll}^{\rm fid, theory}}}}
\def\sigmaTotTheoryZZ{\ensuremath{\sigma_{\ZZ}^{\rm tot, theory}}}

\newcommand{\sigmaVis}{\ensuremath{\sigma_{\mathrm {vis}}}}
\newcommand{\sigmaInel}{\ensuremath{\sigma_{\mathrm {inel} }}}
\newcommand{\muVis}{\ensuremath{\mu_{\mathrm{vis}}}}

\def\phasespace{phase-space}
...
% See http://tex.stackexchange.com/questions/13914/toc-numbering-problem
...
\newcommand{\measStat}[2]{\ensuremath{#1\, #2\, \rm{(stat)\,}}}
\newcommand{\measStatSyst}[3]{\ensuremath{#1\, #2\, \rm{(stat)\,} #3\, \rm{(syst)}}}
\newcommand{\measSyst}[2]{\ensuremath{#1\, #2\, \rm{(syst)}}}
...
\newcommand{\ZZllllorvv}{\ensuremath{{\ZZ\to\ell^{-}\ell^{+}(\ell^{-}\ell^{+}/\nu\bar{\nu})}}}
...
\newcommand{\ptZ}{\ensuremath{\pt(\Z)}}
\newcommand{\deltaPhiLL}{\ensuremath{\Delta \phi(\ell^{+}\ell^{-})}}
...
\newcommand{\Fij}{\ensuremath{F_{ij}}}
\newcommand{\Yij}{\ensuremath{Y_{ij}}}
\newcommand{\formfactor}{form-factor}
\newcommand{\dsigmavec}{\ensuremath{{\rm \bf d}\vec{\sigma}}}

\newcommand{\sqrtseq}[1]{\ensuremath{{\sqrt{s} = #1}}~\tev}
\newcommand{\sqrts}{\ensuremath{\sqrt{s}}}
\newcommand{\sqrtshat}{\ensuremath{\sqrt{\hat{s}}}}
\newcommand{\shat}{\ensuremath{\hat{s}}}

\newcommand{\teststat}{\ensuremath{q(\vec{f})}}
%\newcommand{\teststat}{\ensuremath{q({\fiV})}}
\newcommand{\profilellh}{profile-likelihood}
\newcommand{\maxprofilellh}{maximum \profilellh}
\newcommand{\betahathat}{\ensuremath{\hat{\hat{\beta}}}}
%Theory
...
\newcommand{\suthree}{\ensuremath{SU(3)}}
...
\newcommand{\mllgtt}{\ensuremath{m_{\ll}>20}~\gev}
...
\newcommand{\segmentTagged}{{Segment-Tagged}}
\newcommand{\caloTagged}{{Calorimeter-Tagged}}
\newcommand{\standAlone}{{Stand-Alone}}
...
\newcommand{\BaurRainwater}{Baur-Rainwater}
\newcommand{\BR}{\BaurRainwater}
\newcommand{\AfterBurner}{After-Burner}
...
%
\newcommand{\cutEff}{\ensuremath{N_{\rm cut} / N_{\rm all}}}
\newcommand{\cutEffNmOne}{\ensuremath{N_{\rm cut} / N_{\rm cut-1}}}
% +--------------------------------------------------------------------+
% |                                                                                   
...
\newcommand{\WW}{\ensuremath{\Wplus\Wminus}}
\newcommand{\WZ}{\ensuremath{\Wpm\Zzero}}
\newcommand{\WZl}{\ensuremath{\Wpm\Zzero}$\rightarrow \ell^\pm \nu \ell^+\ell^- $}
\newcommand{\Wg}{\ensuremath{\Wpm\gamma}}
\newcommand{\Zg}{\ensuremath{\Zzero\gamma}}
\newcommand{\ZZ}{\ensuremath{\Zzero\Zzero}}
\newcommand{\Zorgv}{\ensuremath{\Zzero/\gamma^{\textstyle *}}}
\newcommand{\MV}{\ensuremath{M_{V}} }%
\newcommand{\Mll}{\ensuremath{M_{\ell\ell}} }%
\newcommand{\Mee}{\ensuremath{M_{ee}} }%
...
\newcommand{\Wt}{\ensuremath{\W t}}
\newcommand{\Zt}{\ensuremath{\Z t}}
\newcommand{\singletop}{single-\ensuremath{t}}
%
% +--------------------------------------------------------------------+
% |                                                                    |
% |  e+e-, etc.                                                        |
