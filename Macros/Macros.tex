...
\newcommand{\ndiv}[3][2]{\FPdiv\p{#2}{#3}\FPupn\p{\p{} #1 round}\ensuremath{\FPprint\p}}
\newcommand{\nmult}[3][2]{\FPmul\p{#2}{#3}\FPupn\p{\p{} #1 round}\ensuremath{\FPprint\p}}
\newcommand{\averageCzz}[3]{\FPadd\p{#1}{#2}\FPupn\p{\p{} 3 round}\ensuremath{\FPprint\p}}
