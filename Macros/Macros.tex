...
\def\NObs{\ensuremath{N^{\rm obs}_{\ell\ell\ell'\ell'}}}
\def\NBg{\ensuremath{N^{\rm bkg}_{\ell\ell\ell'\ell'}}}
...
\def\sigmaFidZZllll{\ensuremath{\sigma_{\ZZlplmlplm}^{\rm fid}}}
...
\newcommand{\ZZlplmlplm}{\ensuremath{\ZZ\to\ell^{+}\ell^{-}\ell^{+}\ell^{-}}}
...
\newcommand{\ZZslplmlplm}{\ensuremath{\ZZs\to\ell^{+}\ell^{-}\ell^{+}\ell^{-}}}
\newcommand{\ZZseeee}{\ensuremath{\ZZs\to e^{+}e^{-}e^{+}e^{-}}}
\newcommand{\ZZseemm}{\ensuremath{\ZZs\to e^{+}e^{-}\mu^{+}\mu^{-}}}
\newcommand{\ZZsmmmm}{\ensuremath{\ZZs\to\mu^{+}\mu^{-}\mu^{+}\mu^{-}}}
