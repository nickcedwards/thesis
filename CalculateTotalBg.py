...
dd_bg_est = {
        ...
        "Eight" : {
            "ZZ" : {
                "EEEE" : [ 9.26 , 1.79, 1.59, 0.32 ],
                "MMMM" : [ 1.50 , 3.14, 2.30, 0.77 ],
                "EEMM" : [ 6.64 , 4.54, 2.78, 2.51 ],
                "LLLL" : [ 17.41 , 7.72, 4.04, 3.25 ],
                },
            }
        }
...
ired_bg_est = {
        ...
        "Eight" : {
            "ZZ" : {
                "EEEE" : [ 0.41, 0.01, 0.066],
                "MMMM" : [ 0.48, 0.04, 0.030],
                "EEMM" : [ 0.70, 0.05, 0.039],
                "LLLL" : [ 1.58, 0.08, 0.036],
                },
        }
        }
