...
\def\ZZEightTeVSystematicZZEScaleEEEE{0.42 }
\def\ZZEightTeVSystematicZZEScaleMMMM{0.02 }
\def\ZZEightTeVSystematicZZEScaleEEMM{0.13 }
\def\ZZEightTeVSystematicZZEScaleLLLL{0.12 }
...
\def\ZZEightTeVSystematicZZERecoEEEE{3.13 }
\def\ZZEightTeVSystematicZZERecoMMMM{0.00 }
\def\ZZEightTeVSystematicZZERecoEEMM{1.53 }
\def\ZZEightTeVSystematicZZERecoLLLL{1.39 }
