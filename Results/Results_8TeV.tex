...
%\def\ZZEigtTeVDDBgEstZZEEEE{\ensuremath{9.26 ^{+1.79}_{-1.59}\;\pm0.32}}
%\def\ZZEigtTeVDDBgEstZZMMMM{\ensuremath{1.50 ^{+3.14}_{-2.30}\;\pm0.77}}
%\def\ZZEigtTeVDDBgEstZZEEMM{\ensuremath{6.64 ^{+4.54}_{-2.78}\;\pm2.51}}
%\def\ZZEigtTeVDDBgEstZZLLLL{\ensuremath{17.41 ^{+7.72}_{-4.04}\;\pm3.25}}
\def\ZZEigtTeVDDBgEstZZEEEE{\ensuremath{9.3  ^{+1.8}_{-1.6}\;\pm0.3}}
\def\ZZEigtTeVDDBgEstZZMMMM{\ensuremath{1.5  ^{+3.1}_{-2.3}\;\pm0.8}}
\def\ZZEigtTeVDDBgEstZZEEMM{\ensuremath{6.6  ^{+4.5}_{-2.8}\;\pm2.5}}
\def\ZZEigtTeVDDBgEstZZLLLL{\ensuremath{17.4 ^{+7.7}_{-4.0}\;\pm3.3}}

\def\ZZEigtTeVMCBgEstRedZZEEEE{{4.0}{\errSym{2.7}}}
\def\ZZEigtTeVMCBgEstRedZZMMMM{\ensuremath{<0.6}}
\def\ZZEigtTeVMCBgEstRedZZEEMM{{1.5}{\errSym{0.8}}}
\def\ZZEigtTeVMCBgEstRedZZEEEE{{5.5}{\errSym{2.8}}}

\def\ZZEigtTeVMCBgEstIredZZEEEE{{0.4}{\errSym{0.1}}}
\def\ZZEigtTeVMCBgEstIredZZMMMM{{0.5}{\errSym{0.1}}}
\def\ZZEigtTeVMCBgEstIredZZEEMM{{0.7}{\errSym{0.1}}}
\def\ZZEigtTeVMCBgEstIredZZLLLL{{1.6}{\errSym{0.1}}}

\def\ZZEigtTeVTotalBgEstZZEEEE{{9.66}{\errAsym{1.8}{1.6}}{\errSym{0.3}}}
\def\ZZEigtTeVTotalBgEstZZMMMM{{2.0} {\errAsym{3.1}{2.3}}{\errSym{0.8}}}
\def\ZZEigtTeVTotalBgEstZZEEMM{{7.3} {\errAsym{4.5}{2.8}}{\errSym{2.5}}}
\def\ZZEigtTeVTotalBgEstZZLLLL{{19.0}{\errAsym{7.7}{4.0}}{\errSym{3.3}}}
