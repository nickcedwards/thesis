...
\ZZEightTeVTauContiminationCzzZZEEEE{0.37}
\ZZEightTeVTauContiminationCzzStatZZEEEE{0.06}

\ZZEightTeVOutsideFidContiminationCzzZZEEEE{0.58}
\ZZEightTeVOutsideFidContiminationCzzStatZZEEEE{0.05}

\ZZEightTeVTauContiminationCzzZZMMMM{0.42}
\ZZEightTeVTauContiminationCzzStatZZMMMM{0.05}

\ZZEightTeVOutsideFidContiminationCzzZZMMMM{0.67}
\ZZEightTeVOutsideFidContiminationCzzStatZZMMMM{0.05}


\ZZEightTeVTauContiminationCzzZZEEMM{0.19}
\ZZEightTeVTauContiminationCzzStatZZEEMM{0.03}

\ZZEightTeVOutsideFidContiminationCzzZZEEMM{0.56}
\ZZEightTeVOutsideFidContiminationCzzStatZZEEMM{0.05}

\ZZEightTeVTauContiminationCzzZZLLLL{0.30}
\ZZEightTeVTauContiminationCzzStatZZLLLL{0.02}

\ZZEightTeVOutsideFidContiminationCzzZZLLLL{0.60}
\ZZEightTeVOutsideFidContiminationCzzStatZZLLLL{0.03}
