...
\def\ZZEightTeVTauContiminationCzzStatZZEEEE{0.06}

\def\ZZEightTeVOutsideFidContiminationCzzZZEEEE{0.58}
\def\ZZEightTeVOutsideFidContiminationCzzStatZZEEEE{0.05}

\def\ZZEightTeVTauContiminationCzzZZMMMM{0.42}
\def\ZZEightTeVTauContiminationCzzStatZZMMMM{0.05}

\def\ZZEightTeVOutsideFidContiminationCzzZZMMMM{0.67}
\def\ZZEightTeVOutsideFidContiminationCzzStatZZMMMM{0.05}


\def\ZZEightTeVTauContiminationCzzZZEEMM{0.19}
\def\ZZEightTeVTauContiminationCzzStatZZEEMM{0.03}

\def\ZZEightTeVOutsideFidContiminationCzzZZEEMM{0.56}
\def\ZZEightTeVOutsideFidContiminationCzzStatZZEEMM{0.05}

\def\ZZEightTeVTauContiminationCzzZZLLLL{0.30}
\def\ZZEightTeVTauContiminationCzzStatZZLLLL{0.02}

\def\ZZEightTeVOutsideFidContiminationCzzZZLLLL{0.60}
\def\ZZEightTeVOutsideFidContiminationCzzStatZZLLLL{0.03}
