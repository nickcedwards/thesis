...
\def\ZZEightTeVTauContiminationCzzZZStatEEEE{0.06}

\def\ZZEightTeVOutsideFidContiminationCzzZZEEEE{0.58}
\def\ZZEightTeVOutsideFidContiminationCzzZZStatEEEE{0.05}

\def\ZZEightTeVTauContiminationCzzZZMMMM{0.42}
\def\ZZEightTeVTauContiminationCzzZZStatMMMM{0.05}

\def\ZZEightTeVOutsideFidContiminationCzzZZMMMM{0.67}
\def\ZZEightTeVOutsideFidContiminationCzzZZStatMMMM{0.05}


\def\ZZEightTeVTauContiminationCzzZZEEMM{0.19}
\def\ZZEightTeVTauContiminationCzzZZStatEEMM{0.03}

\def\ZZEightTeVOutsideFidContiminationCzzZZEEMM{0.56}
\def\ZZEightTeVOutsideFidContiminationCzzZZStatEEMM{0.05}

\def\ZZEightTeVTauContiminationCzzZZLLLL{0.30}
\def\ZZEightTeVTauContiminationCzzZZStatLLLL{0.02}

\def\ZZEightTeVOutsideFidContiminationCzzZZLLLL{0.60}
\def\ZZEightTeVOutsideFidContiminationCzzZZStatLLLL{0.03}
